...
export interface SafeCall_Succeeds_InvariantsInterface extends utils.Interface {
  functions: {
    ...
    "invariant_callWithMinGas_alwaysForwardsMinGas_succeeds()": FunctionFragment;
    "performSafeCallMinGas(address,uint64)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_callWithMinGas_alwaysForwardsMinGas_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "performSafeCallMinGas",
...
export interface SafeCall_Succeeds_Invariants extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeCall_Succeeds_InvariantsInterface;
