...
export interface SafeCall_Fails_InvariantsInterface extends utils.Interface {
  functions: {
    ...
    "invariant_callWithMinGas_neverForwardsMinGas_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_callWithMinGas_neverForwardsMinGas_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SafeCall_Fails_Invariants extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeCall_Fails_InvariantsInterface;
