...
export interface SafeCall_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_callWithMinGas_hasEnough_succeeds(address,address,uint64,uint64,bytes)": FunctionFragment;
    "testFuzz_call_succeeds(address,address,uint256,uint64,bytes)": FunctionFragment;
    "testFuzz_sendWithGas_succeeds(address,address,uint64,uint256)": FunctionFragment;
    "testFuzz_send_succeeds(address,address,uint256)": FunctionFragment;
    "test_callWithMinGas_noLeakageHigh_succeeds()": FunctionFragment;
    "test_callWithMinGas_noLeakageLow_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_callWithMinGas_hasEnough_succeeds",
    values: [string, string, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_call_succeeds",
    values: [string, string, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_sendWithGas_succeeds",
    values: [string, string, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_send_succeeds",
    values: [string, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_callWithMinGas_noLeakageHigh_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_callWithMinGas_noLeakageLow_succeeds",
    values?: undefined
  ): string;
...
export interface SafeCall_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeCall_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `callWithMinGas` succeeds with enough gas.
     */
    testFuzz_callWithMinGas_hasEnough_succeeds(
      from: string,
      to: string,
    ...
    /**
     * Tests that the `send` function with value succeeds.
     */
    testFuzz_sendWithGas_succeeds(
      _from: string,
      _to: string,
    ...
    /**
     * Tests that the `send` function succeeds.
     */
    testFuzz_send_succeeds(
      _from: string,
      _to: string,
    ...
    /**
     * Tests that `callWithMinGas` succeeds on the upper gas bounds.
     */
    test_callWithMinGas_noLeakageHigh_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `callWithMinGas` succeeds for the lower gas bounds.
     */
    test_callWithMinGas_noLeakageLow_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
