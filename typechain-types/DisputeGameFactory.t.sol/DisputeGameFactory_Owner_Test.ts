...
export interface DisputeGameFactory_Owner_TestInterface
...
export interface DisputeGameFactory_Owner_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_Owner_TestInterface;
