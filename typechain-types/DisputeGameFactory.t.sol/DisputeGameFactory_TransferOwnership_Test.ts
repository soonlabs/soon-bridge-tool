...
export interface DisputeGameFactory_TransferOwnership_TestInterface
  ...
  functions: {
    ...
    "test_transferOwnership_notOwner_reverts()": FunctionFragment;
    "test_transferOwnership_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_transferOwnership_notOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_transferOwnership_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DisputeGameFactory_TransferOwnership_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_TransferOwnership_TestInterface;
  ...
  callStatic: {
     ...
     * Tests that the `transferOwnership` function succeeds when called by the owner.
     */
    test_transferOwnership_succeeds(overrides?: CallOverrides): Promise<void>;
