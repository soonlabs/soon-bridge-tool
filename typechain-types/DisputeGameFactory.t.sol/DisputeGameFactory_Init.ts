...
export interface DisputeGameFactory_InitInterface extends utils.Interface {
  functions: {
...
export interface DisputeGameFactory_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_InitInterface;
