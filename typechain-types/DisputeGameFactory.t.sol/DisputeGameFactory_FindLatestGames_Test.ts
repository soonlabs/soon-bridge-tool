...
export interface DisputeGameFactory_FindLatestGames_TestInterface
  ...
  functions: {
    ...
    "testFuzz_findLatestGames_correctAmount_succeeds(uint256,uint256,uint256)": FunctionFragment;
    "testFuzz_findLatestGames_greaterThanLength_succeeds(uint256)": FunctionFragment;
    "test_findLatestGames_lessThanNAvailable_succeeds()": FunctionFragment;
    "test_findLatestGames_static_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_findLatestGames_correctAmount_succeeds"
      | "testFuzz_findLatestGames_greaterThanLength_succeeds"
      | "test_findLatestGames_lessThanNAvailable_succeeds"
      | "test_findLatestGames_static_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_findLatestGames_correctAmount_succeeds",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_findLatestGames_greaterThanLength_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_findLatestGames_lessThanNAvailable_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_findLatestGames_static_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DisputeGameFactory_FindLatestGames_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_FindLatestGames_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the expected number of games are returned when `findLatestGames` is called.
     */
    testFuzz_findLatestGames_correctAmount_succeeds(
      _numGames: BigNumberish,
      _numSearchedGames: BigNumberish,
      _n: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    /**
     * Tests that `findLatestGames` returns an empty array when the passed starting index is greater than or equal      to the game count.
     */
    testFuzz_findLatestGames_greaterThanLength_succeeds(
      _start: BigNumberish,
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests that `findLatestGames` returns the correct games, if there are less than `_n` games of the given type      available.
     */
    test_findLatestGames_lessThanNAvailable_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `findLatestGames` returns the correct games.
     */
    test_findLatestGames_static_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
