...
export interface DisputeGameFactory_SetInitBond_TestInterface
  ...
  functions: {
    ...
    "test_setInitBond_notOwner_reverts()": FunctionFragment;
    "test_setInitBond_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_setInitBond_notOwner_reverts"
      | "test_setInitBond_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_setInitBond_notOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setInitBond_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DisputeGameFactory_SetInitBond_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_SetInitBond_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the `setInitBond` function reverts when called by a non-owner.
     */
    test_setInitBond_notOwner_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that the `setInitBond` function properly sets the init bond for a given `GameType`.
     */
    test_setInitBond_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that the `setInitBond` function reverts when called by a non-owner.
     */
    test_setInitBond_notOwner_reverts(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that the `setInitBond` function properly sets the init bond for a given `GameType`.
     */
    test_setInitBond_succeeds(overrides?: CallOverrides): Promise<void>;
