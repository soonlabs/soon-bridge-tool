...
export interface DisputeGameFactory_GetGameUUID_TestInterface
  ...
  functions: {
    ...
    "testDiff_getGameUUID_succeeds(uint32,bytes32,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDiff_getGameUUID_succeeds",
...
export interface DisputeGameFactory_GetGameUUID_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_GetGameUUID_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the `getGameUUID` function returns the correct hash when comparing      against the keccak256 hash of the abi-encoded parameters.
     */
    testDiff_getGameUUID_succeeds(
