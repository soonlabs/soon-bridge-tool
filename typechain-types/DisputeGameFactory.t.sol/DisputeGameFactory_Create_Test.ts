...
export interface DisputeGameFactory_Create_TestInterface
  extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "L1()": FunctionFragment;
    "changeClaimStatus(bytes32,uint8)": FunctionFragment;
    ...
    "testFuzz_create_incorrectBondAmount_reverts(uint32,bytes32,bytes)": FunctionFragment;
    "testFuzz_create_noImpl_reverts(uint32,bytes32,bytes)": FunctionFragment;
    "testFuzz_create_sameUUID_reverts(uint32,bytes32,bytes)": FunctionFragment;
    "testFuzz_create_succeeds(uint32,bytes32,bytes,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_create_incorrectBondAmount_reverts"
  ...
  encodeFunctionData(
    functionFragment: "changeClaimStatus",
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_create_incorrectBondAmount_reverts",
    values: [BigNumberish, BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_create_noImpl_reverts",
    values: [BigNumberish, BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_create_sameUUID_reverts",
    values: [BigNumberish, BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_create_succeeds",
...
export interface DisputeGameFactory_Create_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_Create_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the `create` function reverts when creating a new dispute game with an incorrect bond amount.
     */
    testFuzz_create_incorrectBondAmount_reverts(
    ...
    /**
     * Tests that the `create` function reverts when there is no implementation      set for the given `GameType`.
     */
    testFuzz_create_noImpl_reverts(
      gameType: BigNumberish,
      rootClaim: BytesLike,
    ...
    /**
     * Tests that the `create` function succeeds when creating a new dispute game      with a `GameType` that has an implementation set.
     */
    testFuzz_create_succeeds(
      gameType: BigNumberish,
      rootClaim: BytesLike,
