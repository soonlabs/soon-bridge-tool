...
export interface DisputeGameFactory_SetImplementation_TestInterface
  ...
  functions: {
    ...
    "test_setImplementation_notOwner_reverts()": FunctionFragment;
    "test_setImplementation_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_setImplementation_notOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setImplementation_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DisputeGameFactory_SetImplementation_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_SetImplementation_TestInterface;
  ...
  callStatic: {
     ...
     * Tests that the `setImplementation` function properly sets the implementation for a given `GameType`.
     */
    test_setImplementation_succeeds(overrides?: CallOverrides): Promise<void>;
