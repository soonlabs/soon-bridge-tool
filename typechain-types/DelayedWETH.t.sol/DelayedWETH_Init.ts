...
export interface DelayedWETH_InitInterface extends utils.Interface {
  functions: {
...
export interface DelayedWETH_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelayedWETH_InitInterface;
