...
export interface DelayedWETH_Recover_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_recover_succeeds(uint256,uint256)": FunctionFragment;
    "test_recover_byNonOwner_fails()": FunctionFragment;
    "test_recover_moreThanBalance_succeeds()": FunctionFragment;
    "test_recover_whenRecipientReverts_fails()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_recover_succeeds"
      | "test_recover_byNonOwner_fails"
      | "test_recover_moreThanBalance_succeeds"
      | "test_recover_whenRecipientReverts_fails"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_recover_succeeds",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_recover_byNonOwner_fails",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_recover_moreThanBalance_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_recover_whenRecipientReverts_fails",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DelayedWETH_Recover_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelayedWETH_Recover_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that recovering WETH succeeds. Makes sure that doing so succeeds with any amount      of ETH in the contract and any amount of gas used in the fallback function up to a      maximum of 20,000,000 gas. Owner contract should never be using that much gas but we      might as well set a very large upper bound for ourselves.
     * @param _amount Amount of WETH to recover.
     * @param _fallbackGasUsage Amount of gas to use in the fallback function.
     */
    testFuzz_recover_succeeds(
      _amount: BigNumberish,
      _fallbackGasUsage: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    /**
     * Tests that recovering WETH by non-owner fails.
     */
    test_recover_byNonOwner_fails(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that recovering more than the balance recovers what it can.
     */
    test_recover_moreThanBalance_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that recover reverts when recipient reverts.
     */
    test_recover_whenRecipientReverts_fails(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that recovering WETH by non-owner fails.
     */
    test_recover_byNonOwner_fails(overrides?: CallOverrides): Promise<void>;
