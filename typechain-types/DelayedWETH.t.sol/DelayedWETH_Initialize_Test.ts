...
export interface DelayedWETH_Initialize_TestInterface extends utils.Interface {
  functions: {
...
export interface DelayedWETH_Initialize_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelayedWETH_Initialize_TestInterface;
