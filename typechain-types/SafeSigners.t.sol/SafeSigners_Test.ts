...
export interface SafeSigners_TestInterface extends utils.Interface {
  functions: {
    ...
    "testDiff_getSignaturesVsCheckSignatures_succeeds(bytes,uint256)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testDiff_getSignaturesVsCheckSignatures_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDiff_getSignaturesVsCheckSignatures_succeeds",
...
export interface SafeSigners_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeSigners_TestInterface;
