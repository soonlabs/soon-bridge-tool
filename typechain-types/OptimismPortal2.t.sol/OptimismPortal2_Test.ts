...
export interface OptimismPortal2_TestInterface extends utils.Interface {
  functions: {
...
export interface OptimismPortal2_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2_TestInterface;
