...
export interface OptimismPortal2WithMockERC20_TestInterface
  ...
  functions: {
    ...
    "test_depositTransaction_customGasToken_withValue_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_depositTransaction_customGasToken_withValue_reverts"
  ...
  encodeFunctionData(
    functionFragment: "test_depositTransaction_customGasToken_withValue_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal2WithMockERC20_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2WithMockERC20_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `depositERC20Transaction` reverts with NotAllow.
     */
    test_depositERC20Transaction_notAllow_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` fails when a custom gas token is used and msg.value is non-zero.
     */
    test_depositTransaction_customGasToken_withValue_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
