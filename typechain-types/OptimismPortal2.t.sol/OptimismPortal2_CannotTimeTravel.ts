...
export interface OptimismPortal2_CannotTimeTravelInterface
  ...
  functions: {
    ...
    "invariant_cannotFinalizeBeforePeriodHasPassed()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_cannotFinalizeBeforePeriodHasPassed",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal2_CannotTimeTravel extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2_CannotTimeTravelInterface;
