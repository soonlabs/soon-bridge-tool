...
export interface OptimismPortal2_Deposit_InvariantInterface
  ...
  functions: {
    ...
    "invariant_deposit_completes()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_deposit_completes",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal2_Deposit_Invariant extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2_Deposit_InvariantInterface;
  ...
  functions: {
    ...
    /**
     */
    invariant_deposit_completes(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    /**
     */
    invariant_deposit_completes(overrides?: CallOverrides): Promise<BigNumber>;
