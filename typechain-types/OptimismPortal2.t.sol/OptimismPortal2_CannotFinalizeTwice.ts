...
export interface OptimismPortal2_CannotFinalizeTwiceInterface
  ...
  functions: {
    ...
    "invariant_cannotFinalizeTwice()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_cannotFinalizeTwice",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal2_CannotFinalizeTwice extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2_CannotFinalizeTwiceInterface;
  ...
  callStatic: {
    ...
    /**
     */
    invariant_cannotFinalizeTwice(overrides?: CallOverrides): Promise<void>;
