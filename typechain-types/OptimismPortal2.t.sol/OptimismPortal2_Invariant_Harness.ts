...
export interface OptimismPortal2_Invariant_HarnessInterface
...
export interface OptimismPortal2_Invariant_Harness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2_Invariant_HarnessInterface;
