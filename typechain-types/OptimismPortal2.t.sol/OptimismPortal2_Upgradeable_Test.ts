...
export interface OptimismPortal2_Upgradeable_TestInterface
  ...
  functions: {
    ...
    "test_params_initValuesOnProxy_succeeds()": FunctionFragment;
    "test_upgradeToAndCall_upgrading_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_params_initValuesOnProxy_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_upgradeToAndCall_upgrading_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal2_Upgradeable_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal2_Upgradeable_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the proxy can be upgraded.
     */
    test_upgradeToAndCall_upgrading_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
