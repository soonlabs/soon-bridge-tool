...
export interface DeputyGuardianModule_SetAnchorState_TestInterface
...
export interface DeputyGuardianModule_SetAnchorState_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_SetAnchorState_TestInterface;
