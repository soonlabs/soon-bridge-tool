...
export interface DeputyGuardianModule_TestInitInterface
...
export interface DeputyGuardianModule_TestInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_TestInitInterface;
