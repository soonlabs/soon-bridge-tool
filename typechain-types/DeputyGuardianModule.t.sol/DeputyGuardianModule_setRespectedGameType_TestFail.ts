...
export interface DeputyGuardianModule_setRespectedGameType_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_setRespectedGameType_notDeputyGuardian_reverts(uint32)": FunctionFragment;
    "test_setRespectedGameType_targetReverts_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_setRespectedGameType_notDeputyGuardian_reverts"
      | "test_setRespectedGameType_targetReverts_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_setRespectedGameType_notDeputyGuardian_reverts",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_setRespectedGameType_targetReverts_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DeputyGuardianModule_setRespectedGameType_TestFail
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_setRespectedGameType_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `setRespectedGameType` when called by a non deputy guardian.
     */
    testFuzz_setRespectedGameType_notDeputyGuardian_reverts(
