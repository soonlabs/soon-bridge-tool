...
export interface DeputyGuardianModule_setRespectedGameType_TestInterface
  ...
  functions: {
    ...
    "testFuzz_setRespectedGameType_succeeds(uint32)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_setRespectedGameType_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_setRespectedGameType_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface DeputyGuardianModule_setRespectedGameType_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_setRespectedGameType_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `setRespectedGameType` successfully updates the respected game type when called by the deputy guardian.
     */
    testFuzz_setRespectedGameType_succeeds(
