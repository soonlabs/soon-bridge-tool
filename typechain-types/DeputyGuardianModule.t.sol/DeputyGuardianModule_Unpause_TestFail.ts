...
export interface DeputyGuardianModule_Unpause_TestFailInterface
  ...
  functions: {
    ...
    "test_unpause_notDeputyGuardian_reverts()": FunctionFragment;
    "test_unpause_succeeds()": FunctionFragment;
    "test_unpause_targetReverts_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_unpause_notDeputyGuardian_reverts"
      | "test_unpause_succeeds"
      | "test_unpause_targetReverts_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_unpause_notDeputyGuardian_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_unpause_targetReverts_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DeputyGuardianModule_Unpause_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_Unpause_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Sets up the test environment with the SuperchainConfig paused
     */
    setUp(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `unpause` reverts when called by a non deputy guardian.
     */
    test_unpause_notDeputyGuardian_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `unpause` successfully unpauses when called by the deputy guardian.
     */
    test_unpause_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that when the call from the Safe reverts, the error message is returned.
     */
    test_unpause_targetReverts_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
