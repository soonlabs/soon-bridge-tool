...
export interface DeputyGuardianModule_BlacklistDisputeGame_TestInterface
  ...
  functions: {
    ...
    "test_blacklistDisputeGame_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_blacklistDisputeGame_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_blacklistDisputeGame_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DeputyGuardianModule_BlacklistDisputeGame_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_BlacklistDisputeGame_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `blacklistDisputeGame` successfully blacklists a dispute game when called by the deputy guardian.
     */
    test_blacklistDisputeGame_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
