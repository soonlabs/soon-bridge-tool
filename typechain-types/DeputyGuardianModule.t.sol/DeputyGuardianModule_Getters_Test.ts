...
export interface DeputyGuardianModule_Getters_TestInterface
...
export interface DeputyGuardianModule_Getters_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_Getters_TestInterface;
