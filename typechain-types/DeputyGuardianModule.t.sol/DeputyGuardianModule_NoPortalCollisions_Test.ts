...
export interface DeputyGuardianModule_NoPortalCollisions_TestInterface
  ...
  functions: {
    ...
    "test_noPortalCollisions_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_noPortalCollisions_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_noPortalCollisions_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DeputyGuardianModule_NoPortalCollisions_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_NoPortalCollisions_TestInterface;
  ...
  functions: {
    ...
    /**
     * tests that no function selectors in the L1 contracts collide with the OptimismPortal2 functions called by      the DeputyGuardianModule.
     */
    test_noPortalCollisions_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * tests that no function selectors in the L1 contracts collide with the OptimismPortal2 functions called by      the DeputyGuardianModule.
     */
    test_noPortalCollisions_succeeds(overrides?: CallOverrides): Promise<void>;
