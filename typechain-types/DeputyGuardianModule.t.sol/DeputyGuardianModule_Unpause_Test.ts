...
export interface DeputyGuardianModule_Unpause_TestInterface
...
export interface DeputyGuardianModule_Unpause_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_Unpause_TestInterface;
