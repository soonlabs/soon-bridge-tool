...
export interface DeputyGuardianModule_Pause_TestInterface
...
export interface DeputyGuardianModule_Pause_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeputyGuardianModule_Pause_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `pause` successfully pauses when called by the deputy guardian.
     */
    test_pause_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
