...
export interface LibClock_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_duration_succeeds(uint64,uint64)": FunctionFragment;
    "testFuzz_timestamp_succeeds(uint64,uint64)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_duration_succeeds"
      | "testFuzz_timestamp_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_duration_succeeds",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_timestamp_succeeds",
    values: [BigNumberish, BigNumberish]
  ): string;
...
export interface LibClock_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LibClock_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the `duration` function correctly shifts out the `Duration` from a packed `Clock` type.
     */
    testFuzz_duration_succeeds(
    ...
    /**
     * Tests that the `timestamp` function correctly shifts out the `Timestamp` from a packed `Clock` type.
     */
    testFuzz_timestamp_succeeds(
      _duration: BigNumberish,
      _timestamp: BigNumberish,
