...
export interface IOptimismMintableERC200815Interface extends utils.Interface {
  functions: {
...
export interface IOptimismMintableERC200815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOptimismMintableERC200815Interface;
