...
export interface OptimismPortal_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_balance_ether_succeeds(uint256)": FunctionFragment;
    "testFuzz_depositTransaction_smallGasLimit_succeeds(bytes,bool)": FunctionFragment;
    "test_constructor_succeeds()": FunctionFragment;
    "test_depositERC20Transaction_NotAllow_reverts()": FunctionFragment;
    "test_depositTransaction_callPaused_reverts()": FunctionFragment;
    "test_depositTransaction_contractCreation_reverts()": FunctionFragment;
    "test_depositTransaction_largeData_reverts()": FunctionFragment;
    "test_depositTransaction_smallGasLimit_reverts()": FunctionFragment;
    "test_depositTransaction_valueHaveDust_reverts()": FunctionFragment;
    "test_depositTransaction_valueTooLow_reverts()": FunctionFragment;
    "test_initialize_succeeds()": FunctionFragment;
    "test_isOutputFinalized_succeeds()": FunctionFragment;
    "test_minimumGasLimit_succeeds()": FunctionFragment;
    "test_pause_onlyGuardian_reverts()": FunctionFragment;
    "test_pause_succeeds()": FunctionFragment;
    "test_simple_isOutputFinalized_succeeds()": FunctionFragment;
    "test_unpause_onlyGuardian_reverts()": FunctionFragment;
    "test_unpause_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_depositERC20Transaction_NotAllow_reverts"
      | "test_depositTransaction_callPaused_reverts"
      ...
      | "test_depositTransaction_valueHaveDust_reverts"
      | "test_depositTransaction_valueTooLow_reverts"
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_balance_ether_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_depositTransaction_smallGasLimit_succeeds",
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20Transaction_NotAllow_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositTransaction_callPaused_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositTransaction_contractCreation_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositTransaction_largeData_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositTransaction_smallGasLimit_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositTransaction_valueHaveDust_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositTransaction_valueTooLow_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_isOutputFinalized_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_minimumGasLimit_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_pause_onlyGuardian_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_pause_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_simple_isOutputFinalized_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_unpause_onlyGuardian_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_unpause_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `balance()` returns the correct balance when the gas paying token is ether.
     */
    testFuzz_balance_ether_succeeds(
    ...
    /**
     * Tests that `depositTransaction` succeeds for small,      but sufficient, gas limits.
     */
    testFuzz_depositTransaction_smallGasLimit_succeeds(
      _data: BytesLike,
      _shouldFail: boolean,
    ...
    /**
     * Tests that the constructor sets the correct values.
     * Marked virtual to be overridden in         test/kontrol/deployment/DeploymentSummary.t.sol
     */
    test_constructor_succeeds(
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests that `depositERC20Transaction` reverts when the gas paying token is ether.
     */
    test_depositERC20Transaction_NotAllow_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` reverts when paused
     */
    test_depositTransaction_callPaused_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` reverts when the destination address is non-zero      for a contract creation deposit.
     */
    test_depositTransaction_contractCreation_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` reverts when the data is too large.      This places an upper bound on unsafe blocks sent over p2p.
     */
    test_depositTransaction_largeData_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` reverts when the gas limit is too small.
     */
    test_depositTransaction_smallGasLimit_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` reverts when value have dust.
     */
    test_depositTransaction_valueHaveDust_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `depositTransaction` reverts when value too low.
     */
    test_depositTransaction_valueTooLow_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that the initializer sets the correct values.
     * Marked virtual to be overridden in         test/kontrol/deployment/DeploymentSummary.t.sol
     */
    test_initialize_succeeds(
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests `isOutputFinalized` for a finalized output.
     * Marked virtual to be overridden in         test/kontrol/deployment/DeploymentSummary.t.sol
     */
    test_isOutputFinalized_succeeds(
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests that `minimumGasLimit` succeeds for small calldata sizes.      The gas limit should be 21k for 0 calldata and increase linearly      for larger calldata sizes.
     */
    test_minimumGasLimit_succeeds(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Tests that `pause` reverts when called by a non-GUARDIAN.
     */
    test_pause_onlyGuardian_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `pause` successfully pauses      when called by the GUARDIAN.
     */
    test_pause_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `isOutputFinalized` succeeds for an EOA depositing a tx with ETH and data.
     * Marked virtual to be overridden in         test/kontrol/deployment/DeploymentSummary.t.sol
     */
    test_simple_isOutputFinalized_succeeds(
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests that `unpause` reverts when called by a non-GUARDIAN.
     */
    test_unpause_onlyGuardian_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `unpause` successfully unpauses      when called by the GUARDIAN.
     */
    test_unpause_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Marked virtual to be overridden in         test/kontrol/deployment/DeploymentSummary.t.sol
     */
    test_isOutputFinalized_succeeds(overrides?: CallOverrides): Promise<void>;
     ...
     * Tests that `pause` reverts when called by a non-GUARDIAN.
     */
    test_pause_onlyGuardian_reverts(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that `pause` successfully pauses      when called by the GUARDIAN.
     */
    test_pause_succeeds(overrides?: CallOverrides): Promise<void>;
     ...
     * Tests that `unpause` reverts when called by a non-GUARDIAN.
     */
    test_unpause_onlyGuardian_reverts(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that `unpause` successfully unpauses      when called by the GUARDIAN.
     */
    test_unpause_succeeds(overrides?: CallOverrides): Promise<void>;
