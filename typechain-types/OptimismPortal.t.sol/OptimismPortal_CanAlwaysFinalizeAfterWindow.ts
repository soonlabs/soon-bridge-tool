...
export interface OptimismPortal_CanAlwaysFinalizeAfterWindowInterface
  ...
  functions: {
    ...
    "invariant_canAlwaysFinalize()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_canAlwaysFinalize",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortal_CanAlwaysFinalizeAfterWindow
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal_CanAlwaysFinalizeAfterWindowInterface;
  ...
  callStatic: {
    ...
    /**
     */
    invariant_canAlwaysFinalize(overrides?: CallOverrides): Promise<void>;
