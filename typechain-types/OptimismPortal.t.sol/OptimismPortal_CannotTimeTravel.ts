...
export interface OptimismPortal_CannotTimeTravelInterface
...
export interface OptimismPortal_CannotTimeTravel extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortal_CannotTimeTravelInterface;
