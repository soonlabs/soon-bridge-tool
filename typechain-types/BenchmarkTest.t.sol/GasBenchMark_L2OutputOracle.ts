...
export interface GasBenchMark_L2OutputOracleInterface extends utils.Interface {
  functions: {
    ...
    "test_proposeL2Output_benchmark()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_proposeL2Output_benchmark",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GasBenchMark_L2OutputOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasBenchMark_L2OutputOracleInterface;
  ...
  callStatic: {
    ...
    test_proposeL2Output_benchmark(overrides?: CallOverrides): Promise<void>;
