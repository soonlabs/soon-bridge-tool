...
export interface GasBenchMark_L1StandardBridge_FinalizeInterface
  ...
  functions: {
    ...
    "test_finalizeETHWithdrawal_benchmark()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeETHWithdrawal_benchmark",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GasBenchMark_L1StandardBridge_Finalize extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasBenchMark_L1StandardBridge_FinalizeInterface;
