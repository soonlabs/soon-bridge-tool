...
export interface SetPrevBaseFee_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_setPrevBaseFee_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_setPrevBaseFee_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SetPrevBaseFee_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetPrevBaseFee_TestInterface;
  ...
  callStatic: {
    ...
    test_setPrevBaseFee_succeeds(overrides?: CallOverrides): Promise<void>;
