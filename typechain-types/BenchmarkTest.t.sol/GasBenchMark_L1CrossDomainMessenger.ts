...
export interface GasBenchMark_L1CrossDomainMessengerInterface
  ...
  functions: {
    ...
    "test_sendMessage_benchmark_0()": FunctionFragment;
    "test_sendMessage_benchmark_1()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_sendMessage_benchmark_0",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_sendMessage_benchmark_1",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GasBenchMark_L1CrossDomainMessenger extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasBenchMark_L1CrossDomainMessengerInterface;
  ...
  callStatic: {
    ...
    test_sendMessage_benchmark_0(overrides?: CallOverrides): Promise<void>;

    test_sendMessage_benchmark_1(overrides?: CallOverrides): Promise<void>;
