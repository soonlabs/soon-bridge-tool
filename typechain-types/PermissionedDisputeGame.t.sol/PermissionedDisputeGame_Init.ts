...
export interface PermissionedDisputeGame_InitInterface extends utils.Interface {
  functions: {
...
export interface PermissionedDisputeGame_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PermissionedDisputeGame_InitInterface;
