...
export interface PermissionedDisputeGame_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_createGame_notProposer_reverts(address)": FunctionFragment;
    "test_createGame_proposer_succeeds()": FunctionFragment;
    "test_participateInGame_challenger_succeeds()": FunctionFragment;
    "test_participateInGame_notAuthorized_reverts(address)": FunctionFragment;
    "test_participateInGame_proposer_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_createGame_notProposer_reverts"
      | "test_createGame_proposer_succeeds"
      | "test_participateInGame_challenger_succeeds"
      | "test_participateInGame_notAuthorized_reverts"
      | "test_participateInGame_proposer_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_createGame_notProposer_reverts",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "test_createGame_proposer_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_participateInGame_challenger_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_participateInGame_notAuthorized_reverts",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "test_participateInGame_proposer_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PermissionedDisputeGame_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PermissionedDisputeGame_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the permissioned game cannot be created by any address other than the proposer.
     */
    testFuzz_createGame_notProposer_reverts(
      _p: string,
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests that the proposer can create a permissioned dispute game.
     */
    test_createGame_proposer_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that the challenger can participate in a permissioned dispute game.
     */
    test_participateInGame_challenger_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that addresses that are not the proposer or challenger cannot participate in a permissioned dispute      game.
     */
    test_participateInGame_notAuthorized_reverts(
      _p: string,
      overrides?: Overrides & { from?: string }
    ...
    /**
     * Tests that the proposer can participate in a permissioned dispute game.
     */
    test_participateInGame_proposer_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that the proposer can create a permissioned dispute game.
     */
    test_createGame_proposer_succeeds(overrides?: CallOverrides): Promise<void>;
