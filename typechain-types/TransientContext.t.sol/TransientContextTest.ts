...
export interface TransientContextTestInterface extends utils.Interface {
  functions: {
...
export interface TransientContextTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TransientContextTestInterface;
