...
export interface LivenessGuard_CheckTx_TestFailsInterface
  ...
  functions: {
    ...
    "test_checkTransaction_callerIsNotSafe_revert()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_checkTransaction_callerIsNotSafe_revert"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_checkTransaction_callerIsNotSafe_revert",
    values?: undefined
  ): string;
...
export interface LivenessGuard_CheckTx_TestFails extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_CheckTx_TestFailsInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the checkTransaction function reverts if the caller is not the Safe
     */
    test_checkTransaction_callerIsNotSafe_revert(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
