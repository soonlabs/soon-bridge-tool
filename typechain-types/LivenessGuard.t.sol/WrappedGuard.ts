...
export interface WrappedGuardInterface extends utils.Interface {
  functions: {
    ...
    "ownersBeforeLength()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ownersBeforeLength",
    values?: undefined
  ): string;
...
export interface WrappedGuard extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrappedGuardInterface;
  ...
  functions: {
    ...
    ownersBeforeLength(overrides?: CallOverrides): Promise<[BigNumber]>;
