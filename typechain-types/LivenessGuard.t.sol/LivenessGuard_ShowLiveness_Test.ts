...
export interface LivenessGuard_ShowLiveness_TestInterface
  ...
  functions: {
    ...
    "test_showLiveness_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_showLiveness_succeeds",
    values?: undefined
  ): string;
...
export interface LivenessGuard_ShowLiveness_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_ShowLiveness_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the showLiveness function succeeds
     */
    test_showLiveness_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that the showLiveness function succeeds
     */
    test_showLiveness_succeeds(overrides?: CallOverrides): Promise<void>;
  };
