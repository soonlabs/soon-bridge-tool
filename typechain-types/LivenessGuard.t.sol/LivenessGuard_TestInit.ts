...
export interface LivenessGuard_TestInitInterface extends utils.Interface {
  functions: {
...
export interface LivenessGuard_TestInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_TestInitInterface;
