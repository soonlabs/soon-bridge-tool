...
export interface LivenessGuard_ShowLiveness_TestFailInterface
  ...
  functions: {
    ...
    "test_showLiveness_callIsNotSafeOwner_reverts()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_showLiveness_callIsNotSafeOwner_reverts"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_showLiveness_callIsNotSafeOwner_reverts",
    values?: undefined
  ): string;
...
export interface LivenessGuard_ShowLiveness_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_ShowLiveness_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the showLiveness function reverts if the caller is not an owner
     */
    test_showLiveness_callIsNotSafeOwner_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
