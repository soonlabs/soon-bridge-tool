...
export interface LivenessGuard_Getters_TestInterface extends utils.Interface {
  functions: {
...
export interface LivenessGuard_Getters_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_Getters_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the getters return the correct values
     */
