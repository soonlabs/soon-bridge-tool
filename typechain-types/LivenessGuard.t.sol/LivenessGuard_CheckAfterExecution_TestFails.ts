...
export interface LivenessGuard_CheckAfterExecution_TestFailsInterface
  ...
  functions: {
    ...
    "test_checkAfterExecution_callerIsNotSafe_revert()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_checkAfterExecution_callerIsNotSafe_revert",
    values?: undefined
  ): string;
...
export interface LivenessGuard_CheckAfterExecution_TestFails
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_CheckAfterExecution_TestFailsInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the checkAfterExecution function reverts if the caller is not the Safe
     */
    test_checkAfterExecution_callerIsNotSafe_revert(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
