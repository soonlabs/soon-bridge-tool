...
export declare namespace LivenessGuard_FuzzOwnerManagement_Test {
  export type OwnerChangeStruct = {
  ...
  export type OwnerChangeStructOutput = [
    number,
    number,
    BigNumber,
    BigNumber
...
export interface LivenessGuard_FuzzOwnerManagement_TestInterface
  ...
  functions: {
    ...
    "testFuzz_OwnerManagement_works(uint256,uint256,(uint8,uint8,uint256,uint256)[])": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_OwnerManagement_works"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_OwnerManagement_works",
    values: [
      BigNumberish,
      BigNumberish,
      LivenessGuard_FuzzOwnerManagement_Test.OwnerChangeStruct[]
    ]
  ): string;
...
export interface LivenessGuard_FuzzOwnerManagement_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_FuzzOwnerManagement_TestInterface;
  ...
  functions: {
    ...
    testFuzz_OwnerManagement_works(
      initialOwners: BigNumberish,
      threshold: BigNumberish,
      changes: LivenessGuard_FuzzOwnerManagement_Test.OwnerChangeStruct[],
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  };
