...
export interface LivenessGuard_OwnerManagement_TestInterface
  ...
  functions: {
    ...
    "test_addOwner_succeeds()": FunctionFragment;
    "test_removeOwner_succeeds()": FunctionFragment;
    "test_swapOwner_succeeds()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_addOwner_succeeds"
      | "test_removeOwner_succeeds"
      | "test_swapOwner_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_addOwner_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_removeOwner_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_swapOwner_succeeds",
    values?: undefined
  ): string;
...
export interface LivenessGuard_OwnerManagement_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_OwnerManagement_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the guard correctly adds an owner to the lastLive mapping when it is added
     */
    test_addOwner_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that the guard correctly deletes the owner from the lastLive mapping when it is removed
     */
    test_removeOwner_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that the guard correctly adds an owner to the lastLive mapping when it is added
     */
    test_addOwner_succeeds(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that the guard correctly deletes the owner from the lastLive mapping when it is removed
     */
    test_removeOwner_succeeds(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that the guard correctly adds an owner to the lastLive mapping when it is added
     */
    test_swapOwner_succeeds(overrides?: CallOverrides): Promise<void>;
  };
