...
export interface LivenessGuard_Constructor_TestInterface
  ...
  functions: {
    ...
    "test_constructor_works()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_constructor_works",
    values?: undefined
  ): string;
...
export interface LivenessGuard_Constructor_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessGuard_Constructor_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the constructor correctly sets the current time as the lastLive time for each owner
     */
    test_constructor_works(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that the constructor correctly sets the current time as the lastLive time for each owner
     */
    test_constructor_works(overrides?: CallOverrides): Promise<void>;
  };
