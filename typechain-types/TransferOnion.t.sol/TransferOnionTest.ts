...
export interface TransferOnionTestInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "_deploy(bytes32)": FunctionFragment;
    "_deploy()": FunctionFragment;
    "_onionize((address,uint256,bytes32)[])": FunctionFragment;
    ...
    "test_unwrap_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "_deploy(bytes32)",
    values: [BytesLike]
  ): string;
  encodeFunctionData(functionFragment: "_deploy()", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "_onionize",
  ...
  encodeFunctionData(
    functionFragment: "test_unwrap_succeeds",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "_onionize", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "excludeArtifacts",
    data: BytesLike
  ): Result;
...
export interface TransferOnionTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TransferOnionTestInterface;
  ...
  functions: {
    ...
    ): Promise<[string, TransferOnion.LayerStructOutput[]]>;
  ...
  callStatic: {
     ...
     * Deploy the TransferOnion with a dummy shell.
     */
    "_deploy()"(overrides?: CallOverrides): Promise<void>;
     ...
     * Tests unwrapping the onion.
     */
    test_unwrap_succeeds(overrides?: CallOverrides): Promise<void>;
  };
  ...
  estimateGas: {
     ...
     * Deploy the TransferOnion with a dummy shell.
     */
    "_deploy()"(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
