...
export interface LibGameId_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_gameId_roundTrip_succeeds(uint32,uint64,address)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_gameId_roundTrip_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_gameId_roundTrip_succeeds",
...
export interface LibGameId_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LibGameId_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that a round trip of packing and unpacking a GameId maintains the same values.
     */
    testFuzz_gameId_roundTrip_succeeds(
