...
export interface PermissionedDisputeGameInterface extends utils.Interface {
  functions: {
...
export interface PermissionedDisputeGame extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PermissionedDisputeGameInterface;
  ...
  functions: {
    ...
    /**
     * Returns the challenger address.
     */
    challenger(
      overrides?: CallOverrides
    ): Promise<[string] & { challenger_: string }>;
    ...
    /**
     * Generic move function, used for both `attack` and `defend` moves._disputed The disputed `Claim`.
