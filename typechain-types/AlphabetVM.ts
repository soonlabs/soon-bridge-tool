...
export interface AlphabetVMInterface extends utils.Interface {
  functions: {
...
export interface AlphabetVM extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AlphabetVMInterface;
  ...
  functions: {
    ...
    ): Promise<[string] & { postState_: string }>;
  };
