...
export interface OptimismSupplyTracker_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_updateAnchorAndSupplies_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_updateAnchorAndSupplies_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_updateAnchorAndSupplies_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismSupplyTracker_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismSupplyTracker_TestInterface;
