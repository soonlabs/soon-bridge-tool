...
export interface CallerCaller0815Interface extends utils.Interface {
  functions: {};
...
export interface CallerCaller0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CallerCaller0815Interface;
