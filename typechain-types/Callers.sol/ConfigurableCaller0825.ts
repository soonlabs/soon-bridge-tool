...
export interface ConfigurableCaller0825Interface extends utils.Interface {
  functions: {
...
export interface ConfigurableCaller0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConfigurableCaller0825Interface;
