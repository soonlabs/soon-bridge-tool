...
export interface CallerCaller0825Interface extends utils.Interface {
  functions: {};
...
export interface CallerCaller0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CallerCaller0825Interface;
