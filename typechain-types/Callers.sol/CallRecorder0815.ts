...
export interface CallRecorder0815Interface extends utils.Interface {
  functions: {
...
export interface CallRecorder0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CallRecorder0815Interface;
