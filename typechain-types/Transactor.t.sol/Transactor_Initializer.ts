...
export interface Transactor_InitializerInterface extends utils.Interface {
  functions: {
...
export interface Transactor_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Transactor_InitializerInterface;
