...
export interface Constants_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_eip1967Constants_succeeds()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_eip1967Constants_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_eip1967Constants_succeeds",
    values?: undefined
  ): string;
...
export interface Constants_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Constants_TestInterface;
  ...
  functions: {
    ...
    /**
     * Check EIP1967 related constants.
     */
    test_eip1967Constants_succeeds(overrides?: CallOverrides): Promise<[void]>;
  };
