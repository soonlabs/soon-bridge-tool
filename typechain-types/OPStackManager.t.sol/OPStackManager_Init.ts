...
export interface OPStackManager_InitInterface extends utils.Interface {
  functions: {
...
export interface OPStackManager_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OPStackManager_InitInterface;
