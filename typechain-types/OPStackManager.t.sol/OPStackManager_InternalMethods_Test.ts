...
export interface OPStackManager_InternalMethods_TestInterface
  ...
  functions: {
    ...
    "test_calculatesBatchInboxAddress_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_calculatesBatchInboxAddress_succeeds",
    values?: undefined
  ): string;
...
export interface OPStackManager_InternalMethods_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OPStackManager_InternalMethods_TestInterface;
