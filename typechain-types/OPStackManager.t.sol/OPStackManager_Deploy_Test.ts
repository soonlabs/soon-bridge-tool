...
export interface OPStackManager_Deploy_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_deploy_l2ChainIdEqualsCurrentChainId_reverts()": FunctionFragment;
    "test_deploy_l2ChainIdEqualsZero_reverts()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_deploy_l2ChainIdEqualsCurrentChainId_reverts"
      | "test_deploy_l2ChainIdEqualsZero_reverts"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_deploy_l2ChainIdEqualsCurrentChainId_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_deploy_l2ChainIdEqualsZero_reverts",
    values?: undefined
  ): string;
...
export interface OPStackManager_Deploy_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OPStackManager_Deploy_TestInterface;
