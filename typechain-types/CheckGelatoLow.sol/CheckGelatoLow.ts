...
export declare namespace CheckGelatoLow {
  ...
  export type ParamsStructOutput = [string, BigNumber, string] & {
    treasury: string;
    threshold: BigNumber;
    recipient: string;
  };
...
export interface CheckGelatoLowInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "_EventToExposeStructInABI__Params((address,uint256,address))": EventFragment;
  };
...
export interface _EventToExposeStructInABI__ParamsEventObject {
  params: CheckGelatoLow.ParamsStructOutput;
}
export type _EventToExposeStructInABI__ParamsEvent = TypedEvent<
  [CheckGelatoLow.ParamsStructOutput],
...
export interface CheckGelatoLow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CheckGelatoLowInterface;
