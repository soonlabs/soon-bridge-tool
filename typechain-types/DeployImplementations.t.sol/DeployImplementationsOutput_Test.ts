...
export interface DeployImplementationsOutput_TestInterface
...
export interface DeployImplementationsOutput_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployImplementationsOutput_TestInterface;
