...
export interface DeployImplementationsInput_TestInterface
...
export interface DeployImplementationsInput_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployImplementationsInput_TestInterface;
