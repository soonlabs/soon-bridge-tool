...
export interface DeployImplementations_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_run_largeChallengePeriodSeconds_reverts(uint256)": FunctionFragment;
    "test_run_succeeds((uint256,uint256,uint256,uint256,uint256))": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_run_largeChallengePeriodSeconds_reverts"
      | "test_run_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_run_largeChallengePeriodSeconds_reverts",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_run_succeeds",
...
export interface DeployImplementations_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployImplementations_TestInterface;
