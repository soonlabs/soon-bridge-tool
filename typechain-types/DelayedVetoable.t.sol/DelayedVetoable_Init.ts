...
export interface DelayedVetoable_InitInterface extends utils.Interface {
  functions: {
...
export interface DelayedVetoable_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelayedVetoable_InitInterface;
