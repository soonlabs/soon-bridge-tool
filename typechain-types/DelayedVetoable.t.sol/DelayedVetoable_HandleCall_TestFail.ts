...
export interface DelayedVetoable_HandleCall_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_handleCall_forwardingTargetRetValue_succeeds(bytes,bytes)": FunctionFragment;
    "testFuzz_handleCall_forwardingTargetReverts_reverts(bytes,bytes)": FunctionFragment;
    "testFuzz_handleCall_forwardingTooSoon_reverts(bytes)": FunctionFragment;
    "testFuzz_handleCall_forwardingTwice_reverts(bytes)": FunctionFragment;
    "testFuzz_handleCall_queuedAtClash_reverts()": FunctionFragment;
    "test_handleCall_unauthorizedInitiation_reverts()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_handleCall_forwardingTargetRetValue_succeeds"
      | "testFuzz_handleCall_forwardingTargetReverts_reverts"
      | "testFuzz_handleCall_forwardingTooSoon_reverts"
      | "testFuzz_handleCall_forwardingTwice_reverts"
      | "testFuzz_handleCall_queuedAtClash_reverts"
      | "test_handleCall_unauthorizedInitiation_reverts"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_handleCall_forwardingTargetRetValue_succeeds",
    values: [BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_handleCall_forwardingTargetReverts_reverts",
    values: [BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_handleCall_forwardingTooSoon_reverts",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_handleCall_forwardingTwice_reverts",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_handleCall_queuedAtClash_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_handleCall_unauthorizedInitiation_reverts",
    values?: undefined
  ): string;
...
export interface DelayedVetoable_HandleCall_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelayedVetoable_HandleCall_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * If the target reverts, it is bubbled up.
     */
    testFuzz_handleCall_forwardingTargetReverts_reverts(
      inData: BytesLike,
      outData: BytesLike,
    ...
    /**
     * The call cannot be forwarded until the delay has passed.
     */
    testFuzz_handleCall_forwardingTooSoon_reverts(
      data: BytesLike,
      overrides?: Overrides & { from?: string }
    ...
    /**
     * The call cannot be forwarded a second time.
     */
    testFuzz_handleCall_forwardingTwice_reverts(
      data: BytesLike,
      overrides?: Overrides & { from?: string }
    ...
    /**
     * A test documenting the single instance in which the contract is not 'transparent' to the initiator.
     */
    testFuzz_handleCall_queuedAtClash_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
