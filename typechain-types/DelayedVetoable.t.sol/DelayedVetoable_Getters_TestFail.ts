...
export interface DelayedVetoable_Getters_TestFailInterface
  ...
  functions: {
    ...
    "test_getters_notZeroAddress_reverts()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_getters_notZeroAddress_reverts"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_getters_notZeroAddress_reverts",
    values?: undefined
  ): string;
...
export interface DelayedVetoable_Getters_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelayedVetoable_Getters_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Check that getter calls from unauthorized entities will revert.
     */
    test_getters_notZeroAddress_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
