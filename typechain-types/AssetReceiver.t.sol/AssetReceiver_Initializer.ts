...
export interface AssetReceiver_InitializerInterface extends utils.Interface {
  functions: {
...
export interface AssetReceiver_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetReceiver_InitializerInterface;
