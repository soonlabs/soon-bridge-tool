...
export interface DeployedSafe0825Interface extends utils.Interface {
  functions: {
...
export interface DeployedSafe0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployedSafe0825Interface;
