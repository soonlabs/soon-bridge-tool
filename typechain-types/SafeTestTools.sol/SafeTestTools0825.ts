...
export interface SafeTestTools0825Interface extends utils.Interface {
  functions: {
...
export interface SafeTestTools0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeTestTools0825Interface;
