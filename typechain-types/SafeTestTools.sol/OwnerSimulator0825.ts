...
export interface OwnerSimulator0825Interface extends utils.Interface {
  functions: {
...
export interface OwnerSimulator0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnerSimulator0825Interface;
