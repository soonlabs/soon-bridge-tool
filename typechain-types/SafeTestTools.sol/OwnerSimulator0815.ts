...
export interface OwnerSimulator0815Interface extends utils.Interface {
  functions: {
    ...
    "removeOwnerWrapped(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "removeOwnerWrapped",
    values: [string, string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface OwnerSimulator0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnerSimulator0815Interface;
  ...
  functions: {
    ...
    /**
     * Exposes the OwnerManager's removeOwner function so that anyone may call without needing auth
     */
    removeOwnerWrapped(
      prevOwner: string,
      owner: string,
