...
export interface L1CrossDomainMessenger_ReinitReentryTestInterface
  ...
  functions: {
    ...
    "reinitAndReenter()": FunctionFragment;
    ...
    "test_relayMessage_replayStraddlingReinit_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_relayMessage_replayStraddlingReinit_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "reinitAndReenter",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "test_relayMessage_replayStraddlingReinit_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1CrossDomainMessenger_ReinitReentryTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1CrossDomainMessenger_ReinitReentryTestInterface;
  ...
  functions: {
    ...
    /**
     * This method will be called by the relayed message, and will attempt to reenter the relayMessage function      exactly once.
     */
    reinitAndReenter(
    ...
    /**
     * Tests that the relayMessage function cannot be reentered by calling the `initialize()` function within the      relayed message.
     */
    test_relayMessage_replayStraddlingReinit_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * This method will be called by the relayed message, and will attempt to reenter the relayMessage function      exactly once.
     */
    reinitAndReenter(overrides?: CallOverrides): Promise<void>;
