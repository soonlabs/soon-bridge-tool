...
export interface CheckGelatoLowTestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_check_highBalance_fails(uint256,address)": FunctionFragment;
    "testFuzz_check_succeeds(uint256,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_check_highBalance_fails"
      | "testFuzz_check_succeeds"
      | "test_name_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_check_highBalance_fails",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_check_succeeds",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
...
export interface CheckGelatoLowTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CheckGelatoLowTestInterface;
  ...
  functions: {
    ...
    /**
     * Deploy the `CheckGelatoLow` and `MockGelatoTreasury` contracts.
     */
    setUp(
    ...
    /**
     * Fuzz the `check` function and assert that it always returns false         when the user's balance in the treasury is greater than or equal         to the threshold.
     */
    testFuzz_check_highBalance_fails(
    ...
    /**
     * Fuzz the `check` function and assert that it always returns true         when the user's balance in the treasury is less than the threshold.
     */
    testFuzz_check_succeeds(
      _threshold: BigNumberish,
      _recipient: string,
