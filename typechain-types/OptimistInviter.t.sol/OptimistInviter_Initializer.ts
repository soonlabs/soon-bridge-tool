...
export interface OptimistInviter_InitializerInterface extends utils.Interface {
  functions: {
...
export interface OptimistInviter_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimistInviter_InitializerInterface;
