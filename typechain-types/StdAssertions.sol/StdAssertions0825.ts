...
export interface StdAssertions0825Interface extends utils.Interface {
  functions: {
    "failed()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "failed"): FunctionFragment;
...
export interface StdAssertions0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdAssertions0825Interface;
