...
export interface StdAssertions0815Interface extends utils.Interface {
  functions: {
...
export interface StdAssertions0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdAssertions0815Interface;
