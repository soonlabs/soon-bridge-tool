...
export interface ERC1155TokenReceiver0825Interface extends utils.Interface {
  functions: {
...
export interface ERC1155TokenReceiver0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155TokenReceiver0825Interface;
