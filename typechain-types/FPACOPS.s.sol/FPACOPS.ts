...
export interface FPACOPSInterface extends utils.Interface {
  functions: {
    ...
    "deployFPAC(address,address,address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "deployFPAC", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "deployImplementations",
    data: BytesLike
  ): Result;
...
export interface FPACOPS extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FPACOPSInterface;
