...
export interface ProtocolVersions_Setters_TestFailInterface
  ...
  functions: {
    ...
    "test_setRecommended_notOwner_reverts()": FunctionFragment;
    "test_setRequired_notOwner_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_setRecommended_notOwner_reverts"
      | "test_setRequired_notOwner_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_setRecommended_notOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setRequired_notOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ProtocolVersions_Setters_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProtocolVersions_Setters_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `setRecommended` reverts if the caller is not the owner.
     */
    test_setRecommended_notOwner_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `setRequired` reverts if the caller is not the owner.
     */
    test_setRequired_notOwner_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that `setRequired` reverts if the caller is not the owner.
     */
    test_setRequired_notOwner_reverts(overrides?: CallOverrides): Promise<void>;
