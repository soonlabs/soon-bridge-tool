...
export interface ProtocolVersions_InitInterface extends utils.Interface {
  functions: {
...
export interface ProtocolVersions_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProtocolVersions_InitInterface;
