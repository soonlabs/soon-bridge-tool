...
export interface ProtocolVersions_Setters_TestInterface
  ...
  functions: {
    ...
    "testFuzz_setRecommended_succeeds(uint256)": FunctionFragment;
    "testFuzz_setRequired_succeeds(uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_setRecommended_succeeds"
      | "testFuzz_setRequired_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_setRecommended_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_setRequired_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ProtocolVersions_Setters_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProtocolVersions_Setters_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `setRecommended` updates the recommended protocol version successfully.
     */
    testFuzz_setRecommended_succeeds(
    ...
    /**
     * Tests that `setRequired` updates the required protocol version successfully.
     */
    testFuzz_setRequired_succeeds(
      _version: BigNumberish,
      overrides?: Overrides & { from?: string }
