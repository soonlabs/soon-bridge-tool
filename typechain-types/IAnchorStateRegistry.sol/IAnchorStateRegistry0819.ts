...
export interface IAnchorStateRegistry0819Interface extends utils.Interface {
  functions: {
...
export interface IAnchorStateRegistry0819 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAnchorStateRegistry0819Interface;
