...
export interface IAnchorStateRegistryInterface extends utils.Interface {
  functions: {
...
export interface IAnchorStateRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAnchorStateRegistryInterface;
