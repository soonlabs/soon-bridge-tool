...
export interface MintManager_constructor_TestInterface extends utils.Interface {
  functions: {
...
export interface MintManager_constructor_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintManager_constructor_TestInterface;
