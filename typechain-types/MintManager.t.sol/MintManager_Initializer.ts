...
export interface MintManager_InitializerInterface extends utils.Interface {
  functions: {
...
export interface MintManager_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintManager_InitializerInterface;
