...
export interface MintManager_upgrade_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_upgrade_fromNotOwner_reverts()": FunctionFragment;
    "test_upgrade_fromOwner_succeeds()": FunctionFragment;
    "test_upgrade_toZeroAddress_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_upgrade_fromNotOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_upgrade_fromOwner_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_upgrade_toZeroAddress_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MintManager_upgrade_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintManager_upgrade_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the upgrade function reverts when attempting to update to the zero      address, even if the caller is the owner.
     */
    test_upgrade_toZeroAddress_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that the upgrade function reverts when called by a non-owner.
     */
    test_upgrade_fromNotOwner_reverts(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that the owner can upgrade the mint manager.
     */
    test_upgrade_fromOwner_succeeds(overrides?: CallOverrides): Promise<void>;
