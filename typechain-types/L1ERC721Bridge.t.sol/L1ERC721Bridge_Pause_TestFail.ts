...
export interface L1ERC721Bridge_Pause_TestFailInterface
  ...
  functions: {
    ...
    "test_pause_finalizeBridgeERC721_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_pause_finalizeBridgeERC721_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_pause_finalizeBridgeERC721_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1ERC721Bridge_Pause_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1ERC721Bridge_Pause_TestFailInterface;
