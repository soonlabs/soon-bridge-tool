...
export interface CheckTrueTestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_always_true_succeeds(bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_always_true_succeeds",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface CheckTrueTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CheckTrueTestInterface;
  ...
  functions: {
    ...
    /**
     * Fuzz the `check` function and assert that it always returns true.
     */
    testFuzz_always_true_succeeds(
      input: BytesLike,
      overrides?: CallOverrides
