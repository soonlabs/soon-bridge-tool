...
export interface L2OutputOracle_updateProposer_TestInterface
  ...
  functions: {
    ...
    "test_proposeWithNewProposer_succeeds()": FunctionFragment;
    "test_updateProposer_notProposer_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_proposeWithNewProposer_succeeds"
      | "test_updateProposer_notProposer_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_proposeWithNewProposer_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_updateProposer_notProposer_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2OutputOracle_updateProposer_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OutputOracle_updateProposer_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `proposeL2Output` succeeds with new proposer address
     */
    test_proposeWithNewProposer_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
