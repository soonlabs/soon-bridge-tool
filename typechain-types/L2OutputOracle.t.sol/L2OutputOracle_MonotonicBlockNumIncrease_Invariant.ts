...
export interface L2OutputOracle_MonotonicBlockNumIncrease_InvariantInterface
  ...
  functions: {
    ...
    "invariant_monotonicBlockNumIncrease()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_monotonicBlockNumIncrease",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2OutputOracle_MonotonicBlockNumIncrease_Invariant
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OutputOracle_MonotonicBlockNumIncrease_InvariantInterface;
  ...
  /**
   */
  invariant_monotonicBlockNumIncrease(overrides?: CallOverrides): Promise<void>;
