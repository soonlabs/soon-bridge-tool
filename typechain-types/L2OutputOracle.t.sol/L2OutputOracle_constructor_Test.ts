...
export interface L2OutputOracle_constructor_TestInterface
...
export interface L2OutputOracle_constructor_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OutputOracle_constructor_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that constructor sets the initial values correctly.
     */
    test_constructor_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
