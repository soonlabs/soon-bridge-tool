...
export interface L2OutputOracleUpgradeable_TestInterface
  ...
  functions: {
    ...
    "test_initialize_badTimestamp_reverts()": FunctionFragment;
    "test_initialize_l2BlockTimeZero_reverts()": FunctionFragment;
    "test_initialize_submissionInterval_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_initialize_badTimestamp_reverts"
      | "test_initialize_l2BlockTimeZero_reverts"
      | "test_initialize_submissionInterval_reverts"
  ...
  encodeFunctionData(
    functionFragment: "test_initialize_badTimestamp_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initialize_l2BlockTimeZero_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initialize_submissionInterval_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2OutputOracleUpgradeable_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OutputOracleUpgradeable_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that initialize reverts if the starting timestamp is invalid.
     */
    test_initialize_badTimestamp_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that initialize reverts if the l2BlockTime is invalid.
     */
    test_initialize_l2BlockTimeZero_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that initialize reverts if the submissionInterval is zero.
     */
    test_initialize_submissionInterval_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that the proxy can be successfully upgraded.
     */
    test_upgrading_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
