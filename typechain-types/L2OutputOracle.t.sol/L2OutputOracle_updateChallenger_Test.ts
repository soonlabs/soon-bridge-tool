...
export interface L2OutputOracle_updateChallenger_TestInterface
  ...
  functions: {
    ...
    "test_deleteOutputsWithNewChallenger_succeeds()": FunctionFragment;
    "test_updateChallenger_ifNotChallenger_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_deleteOutputsWithNewChallenger_succeeds"
      | "test_updateChallenger_ifNotChallenger_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_deleteOutputsWithNewChallenger_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_updateChallenger_ifNotChallenger_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2OutputOracle_updateChallenger_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OutputOracle_updateChallenger_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `deleteL2Outputs` succeeds with new challenger.
     */
    test_deleteOutputsWithNewChallenger_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `updateChallenger` reverts when not called by the challenger.
     */
    test_updateChallenger_ifNotChallenger_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
