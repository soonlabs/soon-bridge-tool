...
export interface DeployOPChainOutput_TestInterface extends utils.Interface {
  functions: {
...
export interface DeployOPChainOutput_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployOPChainOutput_TestInterface;
