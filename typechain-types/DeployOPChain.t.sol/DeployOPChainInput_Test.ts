...
export interface DeployOPChainInput_TestInterface extends utils.Interface {
  functions: {
...
export interface DeployOPChainInput_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployOPChainInput_TestInterface;
