...
export interface StandardBridge_Stateless_TestInterface
  ...
  functions: {
    ...
    "test_isCorrectTokenPair_succeeds()": FunctionFragment;
    "test_isOptimismMintableERC20_succeeds()": FunctionFragment;
    "test_paused_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_isCorrectTokenPair_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_isOptimismMintableERC20_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_paused_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface StandardBridge_Stateless_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StandardBridge_Stateless_TestInterface;
  ...
  functions: {
    ...
    /**
     * Test coverage of isCorrectTokenPair under different types of         tokens.
     */
    test_isCorrectTokenPair_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Test coverage for identifying OptimismMintableERC20 tokens.         This function should return true for both modern and legacy         OptimismMintableERC20 tokens and false for any accounts that         do not implement the interface.
     */
    test_isOptimismMintableERC20_succeeds(
      overrides?: CallOverrides
    ): Promise<[void]>;
    ...
    /**
     * The bridge by default should be unpaused.
     */
    test_paused_succeeds(overrides?: CallOverrides): Promise<[void]>;
  ...
  callStatic: {
     ...
     * Test coverage of isCorrectTokenPair under different types of         tokens.
     */
    test_isCorrectTokenPair_succeeds(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
     ...
     * The bridge by default should be unpaused.
     */
    test_paused_succeeds(overrides?: CallOverrides): Promise<BigNumber>;
