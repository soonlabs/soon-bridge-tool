...
import type { MintManager, MintManagerInterface } from "../MintManager";
...
type MintManagerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MintManagerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MintManager__factory extends ContractFactory {
  constructor(...args: MintManagerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): MintManager {
    return super.attach(address) as MintManager;
  }
  override connect(signer: Signer): MintManager__factory {
    return super.connect(signer) as MintManager__factory;
  }
