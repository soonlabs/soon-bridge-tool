...
type AddressManagerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AddressManagerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AddressManager__factory extends ContractFactory {
  constructor(...args: AddressManagerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<AddressManager> {
    return super.deploy(overrides || {}) as Promise<AddressManager>;
  }
  ...
  override attach(address: string): AddressManager {
    return super.attach(address) as AddressManager;
  }
  override connect(signer: Signer): AddressManager__factory {
    return super.connect(signer) as AddressManager__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AddressManagerInterface {
    return new utils.Interface(_abi) as AddressManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AddressManager {
    return new Contract(address, _abi, signerOrProvider) as AddressManager;
  }
}
