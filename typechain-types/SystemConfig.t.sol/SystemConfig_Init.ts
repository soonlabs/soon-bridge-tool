...
export interface SystemConfig_InitInterface extends utils.Interface {
  functions: {
...
export interface SystemConfig_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemConfig_InitInterface;
