...
export interface SystemConfig_Setters_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_setBatcherHash_succeeds(bytes32)": FunctionFragment;
    "testFuzz_setGasConfig_succeeds(uint256,uint256)": FunctionFragment;
    "testFuzz_setGasLimit_succeeds(uint64)": FunctionFragment;
    "testFuzz_setSequencerPubkey_succeeds()": FunctionFragment;
    "testFuzz_setUnsafeBlockSigner_succeeds(bytes32)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testFuzz_setSequencerPubkey_succeeds"
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_setBatcherHash_succeeds",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_setGasConfig_succeeds",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_setGasLimit_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_setSequencerPubkey_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_setUnsafeBlockSigner_succeeds",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface SystemConfig_Setters_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemConfig_Setters_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `setBatcherHash` updates the batcher hash successfully.
     */
    testFuzz_setBatcherHash_succeeds(
      newBatcherHash: BytesLike,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    /**
     * Tests that `setGasConfig` updates the overhead and scalar successfully.
     */
    testFuzz_setGasConfig_succeeds(
      newOverhead: BigNumberish,
      newScalar: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    /**
     * Tests that `setGasLimit` updates the gas limit successfully.
     */
    testFuzz_setGasLimit_succeeds(
    ...
    /**
     * Tests that `setSequencerPubkey` updates sequencer pubkey successfully.
     */
    testFuzz_setSequencerPubkey_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `setUnsafeBlockSigner` updates the block signer successfully.
     */
    testFuzz_setUnsafeBlockSigner_succeeds(
      newUnsafeSigner: BytesLike,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
