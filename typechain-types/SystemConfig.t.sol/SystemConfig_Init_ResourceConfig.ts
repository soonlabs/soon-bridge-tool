...
export interface SystemConfig_Init_ResourceConfigInterface
  ...
  functions: {
    ...
    "test_setResourceConfig_badMinMax_reverts()": FunctionFragment;
    "test_setResourceConfig_badPrecision_reverts()": FunctionFragment;
    "test_setResourceConfig_lowGasLimit_reverts()": FunctionFragment;
    "test_setResourceConfig_zeroDenominator_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_setResourceConfig_badMinMax_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setResourceConfig_badPrecision_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setResourceConfig_lowGasLimit_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setResourceConfig_zeroDenominator_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SystemConfig_Init_ResourceConfig extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemConfig_Init_ResourceConfigInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `setResourceConfig` reverts if the min base fee      is greater than the maximum allowed base fee.
     */
    test_setResourceConfig_badMinMax_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `setResourceConfig` reverts if the elasticity multiplier      and max resource limit are configured such that there is a loss of precision.
     */
    test_setResourceConfig_badPrecision_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `setResourceConfig` reverts if the gas limit is too low.
     */
    test_setResourceConfig_lowGasLimit_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that `setResourceConfig` reverts if the baseFeeMaxChangeDenominator      is zero.
     */
    test_setResourceConfig_zeroDenominator_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
