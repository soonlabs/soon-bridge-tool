...
export interface SystemConfig_Initialize_TestFailInterface
  ...
  functions: {
    ...
    "test_initialize_lowGasLimit_reverts()": FunctionFragment;
    "test_initialize_succeeds()": FunctionFragment;
    "test_startBlock_update_fails()": FunctionFragment;
    "test_startBlock_update_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_startBlock_update_fails"
      | "test_startBlock_update_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_initialize_lowGasLimit_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_startBlock_update_fails",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_startBlock_update_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SystemConfig_Initialize_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemConfig_Initialize_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that constructor sets the correct values.
     */
    test_constructor_succeeds(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Tests that initialization reverts if the gas limit is too low.
     */
    test_initialize_lowGasLimit_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that initialization sets the correct values.
     */
    test_initialize_succeeds(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Tests that startBlock is not updated when it's not zero.
     */
    test_startBlock_update_fails(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that startBlock is updated correctly when it's zero.
     */
    test_startBlock_update_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that startBlock is not updated when it's not zero.
     */
    test_startBlock_update_fails(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that startBlock is updated correctly when it's zero.
     */
    test_startBlock_update_succeeds(overrides?: CallOverrides): Promise<void>;
