...
export interface SystemConfig_Initialize_TestInterface extends utils.Interface {
  functions: {
...
export interface SystemConfig_Initialize_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemConfig_Initialize_TestInterface;
