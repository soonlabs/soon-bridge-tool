...
export interface L1StandardBridge_Getter_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_getters_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_getters_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_Getter_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_Getter_TestInterface;
  ...
  functions: {
     ...
     */
    test_getters_succeeds(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
     ...
     * Test that the accessors return the correct initialized values.
     */
    test_getters_succeeds(overrides?: CallOverrides): Promise<BigNumber>;
