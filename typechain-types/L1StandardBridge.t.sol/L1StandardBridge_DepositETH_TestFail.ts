...
export interface L1StandardBridge_DepositETH_TestFailInterface
  ...
  functions: {
    ...
    "test_depositETH_disallow_reverts()": FunctionFragment;
    "test_depositETH_notEoa_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_depositETH_disallow_reverts"
  ...
  encodeFunctionData(
    functionFragment: "test_depositETH_disallow_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositETH_notEoa_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositETH_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositETH_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that depositing reverts with disallow.
     */
    test_depositETH_disallow_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that depositing ETH reverts if the call is not from an EOA.
     */
    test_depositETH_notEoa_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that depositing reverts with disallow.
     */
    test_depositETH_disallow_reverts(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that depositing ETH reverts if the call is not from an EOA.
     */
    test_depositETH_notEoa_reverts(overrides?: CallOverrides): Promise<void>;
