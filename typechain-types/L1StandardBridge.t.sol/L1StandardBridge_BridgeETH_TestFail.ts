...
export interface L1StandardBridge_BridgeETH_TestFailInterface
  ...
  functions: {
    ...
    "test_bridgeETH_disallow_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_bridgeETH_disallow_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridgeETH_disallow_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_BridgeETH_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_BridgeETH_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that bridging eth reverts with disallow.
     */
    test_bridgeETH_disallow_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that bridging eth reverts with disallow.
     */
    test_bridgeETH_disallow_reverts(overrides?: CallOverrides): Promise<void>;
