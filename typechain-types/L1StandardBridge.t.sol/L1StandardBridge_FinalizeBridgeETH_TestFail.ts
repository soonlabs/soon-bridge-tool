...
export interface L1StandardBridge_FinalizeBridgeETH_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_finalizeBridgeETH_customGasToken_reverts(uint256,bytes)": FunctionFragment;
    "test_finalizeBridgeETH_incorrectValue_reverts()": FunctionFragment;
    "test_finalizeBridgeETH_sendToMessenger_reverts()": FunctionFragment;
    "test_finalizeBridgeETH_sendToSelf_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_finalizeBridgeETH_customGasToken_reverts"
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_finalizeBridgeETH_customGasToken_reverts",
    values: [BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_incorrectValue_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_sendToMessenger_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_sendToSelf_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_FinalizeBridgeETH_TestFail
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_FinalizeBridgeETH_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that finalizing bridged reverts with custom gas token.
     */
    testFuzz_finalizeBridgeETH_customGasToken_reverts(
      _value: BigNumberish,
    ...
    /**
     * Tests that finalizing bridged ETH reverts if the amount is incorrect.
     */
    test_finalizeBridgeETH_incorrectValue_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that finalizing bridged ETH reverts if the destination is the messenger.
     */
    test_finalizeBridgeETH_sendToMessenger_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that finalizing bridged ETH reverts if the destination is the L1 bridge.
     */
    test_finalizeBridgeETH_sendToSelf_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
