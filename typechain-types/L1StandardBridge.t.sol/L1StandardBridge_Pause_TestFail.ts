...
export interface L1StandardBridge_Pause_TestFailInterface
  ...
  functions: {
    ...
    "test_pause_finalizeBridgeERC20_reverts()": FunctionFragment;
    "test_pause_finalizeBridgeETH_reverts()": FunctionFragment;
    "test_pause_finalizeERC20Withdrawal_reverts()": FunctionFragment;
    "test_pause_finalizeETHWithdrawal_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_pause_finalizeBridgeETH_reverts"
      | "test_pause_finalizeERC20Withdrawal_reverts"
      | "test_pause_finalizeETHWithdrawal_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_pause_finalizeBridgeERC20_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_pause_finalizeBridgeETH_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_pause_finalizeERC20Withdrawal_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_pause_finalizeETHWithdrawal_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_Pause_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_Pause_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Sets up the test by pausing the bridge, giving ether to the bridge and mocking      the calls to the xDomainMessageSender so that it returns the correct value.
     */
    setUp(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Confirms that the `finalizeBridgeERC20` function reverts when the bridge is paused.
     */
    test_pause_finalizeBridgeERC20_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Confirms that the `finalizeBridgeETH` function reverts when the bridge is paused.
     */
    test_pause_finalizeBridgeETH_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Confirms that the `finalizeERC20Withdrawal` function reverts when the bridge is paused.
     */
    test_pause_finalizeERC20Withdrawal_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Confirms that the `finalizeETHWithdrawal` function reverts when the bridge is paused.
     */
    test_pause_finalizeETHWithdrawal_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
