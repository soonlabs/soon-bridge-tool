...
export interface L1StandardBridge_BridgeETHTo_TestInterface
  ...
  functions: {
    ...
    "test_bridgeETHTo_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridgeETHTo_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_BridgeETHTo_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_BridgeETHTo_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that bridging ETH to a different address succeeds.      Emits ETHDepositInitiated and ETHBridgeInitiated events.      Calls depositTransaction on the OptimismPortal.      Only EOA can call bridgeETHTo.      ETH ends up in the optimismPortal.
     */
    test_bridgeETHTo_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that bridging ETH to a different address succeeds.      Emits ETHDepositInitiated and ETHBridgeInitiated events.      Calls depositTransaction on the OptimismPortal.      Only EOA can call bridgeETHTo.      ETH ends up in the optimismPortal.
     */
    test_bridgeETHTo_succeeds(overrides?: CallOverrides): Promise<void>;
