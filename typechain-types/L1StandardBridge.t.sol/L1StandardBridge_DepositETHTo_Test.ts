...
export interface L1StandardBridge_DepositETHTo_TestInterface
  ...
  functions: {
    ...
    "test_depositETHTo_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositETHTo_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositETHTo_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositETHTo_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that depositing ETH to a different address succeeds.      Emits ETHDepositInitiated event.      Calls depositTransaction on the OptimismPortal.      EOA or contract can call depositETHTo.      ETH ends up in the optimismPortal.
     */
    test_depositETHTo_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that depositing ETH to a different address succeeds.      Emits ETHDepositInitiated event.      Calls depositTransaction on the OptimismPortal.      EOA or contract can call depositETHTo.      ETH ends up in the optimismPortal.
     */
    test_depositETHTo_succeeds(overrides?: CallOverrides): Promise<void>;
