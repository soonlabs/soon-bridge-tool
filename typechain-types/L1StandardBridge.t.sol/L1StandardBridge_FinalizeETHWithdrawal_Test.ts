...
export interface L1StandardBridge_FinalizeETHWithdrawal_TestInterface
  ...
  functions: {
    ...
    "test_finalizeETHWithdrawal_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeETHWithdrawal_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_FinalizeETHWithdrawal_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_FinalizeETHWithdrawal_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that finalizing an ETH withdrawal succeeds.      Emits ETHWithdrawalFinalized event.      Only callable by the L2 bridge.
     */
    test_finalizeETHWithdrawal_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
