...
export interface L1StandardBridge_Receive_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_receive_disallow_reverts(uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_receive_disallow_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_receive_disallow_reverts",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_Receive_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_Receive_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests receive function reverts with custom gas token.
     */
    testFuzz_receive_disallow_reverts(
      _value: BigNumberish,
      overrides?: Overrides & { from?: string }
