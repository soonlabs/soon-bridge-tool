...
export interface L1StandardBridge_DepositERC20To_TestInterface
  ...
  functions: {
    ...
    "test_depositERC20To_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20To_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositERC20To_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositERC20To_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that depositing ERC20 to the bridge succeeds when      sent to a different address.      Bridge deposits are updated.      Emits ERC20DepositInitiated event.      Calls depositTransaction on the OptimismPortal.      Contracts can call depositERC20.
     */
    test_depositERC20To_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that depositing ERC20 to the bridge succeeds when      sent to a different address.      Bridge deposits are updated.      Emits ERC20DepositInitiated event.      Calls depositTransaction on the OptimismPortal.      Contracts can call depositERC20.
     */
    test_depositERC20To_succeeds(overrides?: CallOverrides): Promise<void>;
