...
export interface L1StandardBridge_FinalizeERC20Withdrawal_TestInterface
  ...
  functions: {
    ...
    "test_finalizeERC20Withdrawal_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeERC20Withdrawal_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_FinalizeERC20Withdrawal_Test
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_FinalizeERC20Withdrawal_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that finalizing an ERC20 withdrawal succeeds.      Bridge deposits are updated.      Emits ERC20WithdrawalFinalized event.      Only callable by the L2 bridge.
     */
    test_finalizeERC20Withdrawal_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
