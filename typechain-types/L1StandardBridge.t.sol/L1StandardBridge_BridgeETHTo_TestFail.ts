...
export interface L1StandardBridge_BridgeETHTo_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_bridgeETHTo_customGasToken_reverts(uint256,uint32,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_bridgeETHTo_customGasToken_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_bridgeETHTo_customGasToken_reverts",
...
export interface L1StandardBridge_BridgeETHTo_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_BridgeETHTo_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that bridging reverts with custom gas token.
     */
    testFuzz_bridgeETHTo_customGasToken_reverts(
      _value: BigNumberish,
