...
export interface L1StandardBridge_FinalizeERC20Withdrawal_TestFailInterface
  ...
  functions: {
    ...
    "test_finalizeERC20Withdrawal_notMessenger_reverts()": FunctionFragment;
    "test_finalizeERC20Withdrawal_notOtherBridge_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeERC20Withdrawal_notMessenger_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeERC20Withdrawal_notOtherBridge_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_FinalizeERC20Withdrawal_TestFail
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_FinalizeERC20Withdrawal_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that finalizing an ERC20 withdrawal reverts if the caller is not the L2 bridge.
     */
    test_finalizeERC20Withdrawal_notMessenger_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
