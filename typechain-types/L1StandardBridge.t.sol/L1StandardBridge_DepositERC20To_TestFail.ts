...
export interface L1StandardBridge_DepositERC20To_TestFailInterface
  ...
  functions: {
    ...
    "test_depositERC20To_invalidAmount_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_depositERC20To_invalidAmount_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20To_invalidAmount_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositERC20To_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositERC20To_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that depositing an ERC20 to the bridge reverts      if amount is not valid.
     */
    test_depositERC20To_invalidAmount_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
