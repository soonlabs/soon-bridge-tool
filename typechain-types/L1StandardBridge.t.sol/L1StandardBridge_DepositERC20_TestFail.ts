...
export interface L1StandardBridge_DepositERC20_TestFailInterface
  ...
  functions: {
    ...
    "test_depositERC20_disallow_reverts()": FunctionFragment;
    "test_depositERC20_notEoa_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_depositERC20_disallow_reverts"
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20_disallow_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositERC20_notEoa_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositERC20_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositERC20_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that depositing an ERC20 to the bridge reverts      if the caller is not an EOA.
     */
    test_depositERC20_notEoa_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that depositing an ERC20 to the bridge reverts      if the caller is not an EOA.
     */
    test_depositERC20_notEoa_reverts(overrides?: CallOverrides): Promise<void>;
