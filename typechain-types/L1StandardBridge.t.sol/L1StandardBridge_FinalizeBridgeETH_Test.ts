...
export interface L1StandardBridge_FinalizeBridgeETH_TestInterface
  ...
  functions: {
    ...
    "test_finalizeBridgeETH_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_FinalizeBridgeETH_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_FinalizeBridgeETH_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that finalizing bridged ETH succeeds.
     */
    test_finalizeBridgeETH_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that finalizing bridged ETH succeeds.
     */
    test_finalizeBridgeETH_succeeds(overrides?: CallOverrides): Promise<void>;
