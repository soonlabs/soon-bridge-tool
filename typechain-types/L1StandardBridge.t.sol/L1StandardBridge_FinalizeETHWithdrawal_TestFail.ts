...
export interface L1StandardBridge_FinalizeETHWithdrawal_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_finalizeETHWithdrawal_customGasToken_reverts(uint256,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_finalizeETHWithdrawal_customGasToken_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_finalizeETHWithdrawal_customGasToken_reverts",
...
export interface L1StandardBridge_FinalizeETHWithdrawal_TestFail
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_FinalizeETHWithdrawal_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that finalizeETHWithdrawal reverts with custom gas token.
     */
    testFuzz_finalizeETHWithdrawal_customGasToken_reverts(
      _value: BigNumberish,
