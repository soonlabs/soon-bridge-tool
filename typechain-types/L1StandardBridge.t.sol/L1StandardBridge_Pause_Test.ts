...
export interface L1StandardBridge_Pause_TestInterface extends utils.Interface {
  functions: {
...
export interface L1StandardBridge_Pause_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_Pause_TestInterface;
