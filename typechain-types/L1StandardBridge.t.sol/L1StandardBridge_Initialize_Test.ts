...
export interface L1StandardBridge_Initialize_TestInterface
...
export interface L1StandardBridge_Initialize_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_Initialize_TestInterface;
  ...
  functions: {
    ...
    /**
     * Test that the initialize function sets the correct values.
     */
