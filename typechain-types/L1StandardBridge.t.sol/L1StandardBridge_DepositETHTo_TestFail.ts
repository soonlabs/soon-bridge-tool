...
export interface L1StandardBridge_DepositETHTo_TestFailInterface
  ...
  functions: {
    ...
    "testFuzz_depositETHTo_customGasToken_reverts(uint256,bytes32,uint32,bytes)": FunctionFragment;
    "test_depositETHTo_ValueTooLow_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_depositETHTo_customGasToken_reverts"
      | "test_depositETHTo_ValueTooLow_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_depositETHTo_customGasToken_reverts",
    values: [BigNumberish, BytesLike, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositETHTo_ValueTooLow_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositETHTo_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositETHTo_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that depositETHTo reverts with custom gas token.
     */
    testFuzz_depositETHTo_customGasToken_reverts(
      _value: BigNumberish,
      _to: BytesLike,
    ...
    /**
     * Tests that depositETHTo reverts with ValueTooLow
     */
    test_depositETHTo_ValueTooLow_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
