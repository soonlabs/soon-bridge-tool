...
export interface SuperchainConfig_Init_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_initialize_paused_succeeds()": FunctionFragment;
    "test_initialize_unpaused_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_initialize_paused_succeeds"
      | "test_initialize_unpaused_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_initialize_paused_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initialize_unpaused_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SuperchainConfig_Init_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperchainConfig_Init_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that it can be intialized as paused.
     */
    test_initialize_paused_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that initialization sets the correct values. These are defined in CommonTest.sol.
     */
    test_initialize_unpaused_succeeds(
      overrides?: CallOverrides
    ): Promise<[void]>;
   ...
   * Tests that initialization sets the correct values. These are defined in CommonTest.sol.
   */
  test_initialize_unpaused_succeeds(overrides?: CallOverrides): Promise<void>;
  ...
  callStatic: {
     ...
     * Tests that it can be intialized as paused.
     */
    test_initialize_paused_succeeds(overrides?: CallOverrides): Promise<void>;
