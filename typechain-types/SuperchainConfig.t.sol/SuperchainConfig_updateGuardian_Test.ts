...
export interface SuperchainConfig_updateGuardian_TestInterface
  ...
  functions: {
    ...
    "test_pauseWithNewGuardian_succeeds()": FunctionFragment;
    "test_updateGuardian_notGuardian_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_pauseWithNewGuardian_succeeds"
      | "test_updateGuardian_notGuardian_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_pauseWithNewGuardian_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_updateGuardian_notGuardian_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SuperchainConfig_updateGuardian_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperchainConfig_updateGuardian_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that `updateGuardian` reverts when called by a non-guardian.
     */
    test_updateGuardian_notGuardian_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
