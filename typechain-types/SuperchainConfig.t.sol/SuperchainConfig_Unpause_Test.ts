...
export interface SuperchainConfig_Unpause_TestInterface
...
export interface SuperchainConfig_Unpause_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperchainConfig_Unpause_TestInterface;
