...
export interface SuperchainConfig_Pause_TestFailInterface
  ...
  functions: {
    ...
    "test_pause_notGuardian_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_pause_notGuardian_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_pause_notGuardian_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SuperchainConfig_Pause_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperchainConfig_Pause_TestFailInterface;
  ...
  callStatic: {
     ...
     * Tests that `pause` reverts when called by a non-guardian.
     */
    test_pause_notGuardian_reverts(overrides?: CallOverrides): Promise<void>;
