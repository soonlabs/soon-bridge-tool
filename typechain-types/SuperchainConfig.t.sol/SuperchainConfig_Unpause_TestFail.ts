...
export interface SuperchainConfig_Unpause_TestFailInterface
  ...
  functions: {
    ...
    "test_unpause_notGuardian_reverts()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_unpause_notGuardian_reverts"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_unpause_notGuardian_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SuperchainConfig_Unpause_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperchainConfig_Unpause_TestFailInterface;
  ...
  callStatic: {
     ...
     * Tests that `unpause` reverts when called by a non-guardian.
     */
    test_unpause_notGuardian_reverts(overrides?: CallOverrides): Promise<void>;
