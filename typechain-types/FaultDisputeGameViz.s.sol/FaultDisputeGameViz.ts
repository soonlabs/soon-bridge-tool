...
export interface FaultDisputeGameVizInterface extends utils.Interface {
  functions: {
    ...
    "remote(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "remote", values: [string]): string;
...
export interface FaultDisputeGameViz extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FaultDisputeGameVizInterface;
  ...
  callStatic: {
     ...
     * Entry point
     */
    local(overrides?: CallOverrides): Promise<void>;
     ...
     * Entry point
     */
    remote(_addr: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
     ...
     * Entry point
     */
    local(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
