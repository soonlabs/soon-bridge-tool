...
export interface OptimistAllowlist_InitializerInterface
...
export interface OptimistAllowlist_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimistAllowlist_InitializerInterface;
