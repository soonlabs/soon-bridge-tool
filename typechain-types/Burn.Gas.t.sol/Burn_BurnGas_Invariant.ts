...
export interface Burn_BurnGas_InvariantInterface extends utils.Interface {
  functions: {
    ...
    "invariant_burn_gas()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_burn_gas",
    values?: undefined
  ): string;
...
export interface Burn_BurnGas_Invariant extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Burn_BurnGas_InvariantInterface;
  ...
  functions: {
    ...
    /**
     */
    invariant_burn_gas(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    /**
     */
    invariant_burn_gas(overrides?: CallOverrides): Promise<BigNumber>;
