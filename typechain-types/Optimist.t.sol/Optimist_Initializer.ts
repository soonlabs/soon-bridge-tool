...
export interface Optimist_InitializerInterface extends utils.Interface {
  functions: {
...
export interface Optimist_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Optimist_InitializerInterface;
