...
export interface AddressAliasHelper_applyAndUndo_TestInterface
  ...
  functions: {
    ...
    "testFuzz_applyAndUndo_succeeds(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_applyAndUndo_succeeds",
    values: [string]
  ): string;
...
export interface AddressAliasHelper_applyAndUndo_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AddressAliasHelper_applyAndUndo_TestInterface;
