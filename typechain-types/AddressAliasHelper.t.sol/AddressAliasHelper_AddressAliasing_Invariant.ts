...
export interface AddressAliasHelper_AddressAliasing_InvariantInterface
  ...
  functions: {
    ...
    "invariant_round_trip_aliasing()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_round_trip_aliasing",
    values?: undefined
  ): string;
...
export interface AddressAliasHelper_AddressAliasing_Invariant
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AddressAliasHelper_AddressAliasing_InvariantInterface;
  ...
  functions: {
    ...
    /**
     */
    invariant_round_trip_aliasing(overrides?: CallOverrides): Promise<[void]>;
