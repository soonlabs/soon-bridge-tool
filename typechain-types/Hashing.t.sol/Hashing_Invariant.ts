...
export interface Hashing_InvariantInterface extends utils.Interface {
  functions: {
    ...
    "invariant_hash_xdomain_msg_1()": FunctionFragment;
    "invariant_hash_xdomain_msg_wrong_version()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "invariant_hash_xdomain_msg_wrong_version"
      | "setUp"
  ...
  encodeFunctionData(
    functionFragment: "invariant_hash_xdomain_msg_1",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "invariant_hash_xdomain_msg_wrong_version",
    values?: undefined
  ): string;
...
export interface Hashing_Invariant extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Hashing_InvariantInterface;
  ...
  functions: {
    ...
    /**
     */
    invariant_hash_xdomain_msg_1(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    /**
     */
    invariant_hash_xdomain_msg_1(overrides?: CallOverrides): Promise<BigNumber>;
