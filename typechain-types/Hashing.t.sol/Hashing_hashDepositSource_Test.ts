...
export interface Hashing_hashDepositSource_TestInterface
  ...
  functions: {
    ...
    "test_hashDepositSource_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_hashDepositSource_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Hashing_hashDepositSource_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Hashing_hashDepositSource_TestInterface;
  ...
  functions: {
     ...
     */
    test_hashDepositSource_succeeds(overrides?: CallOverrides): Promise<[void]>;
