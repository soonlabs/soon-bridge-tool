...
export interface ArtifactResourceMetering_TestInterface
  ...
  functions: {
    ...
    "test_meter_generateArtifact_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_meter_generateArtifact_succeeds",
    values?: undefined
  ): string;
...
export interface ArtifactResourceMetering_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArtifactResourceMetering_TestInterface;
  ...
  functions: {
    ...
    /**
     * Sets up the tests with constants from the ResourceMetering contract.
     */
    setUp(
