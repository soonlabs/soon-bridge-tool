...
export interface IDisputeGameFactory0819Interface extends utils.Interface {
  functions: {
...
export interface IDisputeGameFactory0819 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDisputeGameFactory0819Interface;
