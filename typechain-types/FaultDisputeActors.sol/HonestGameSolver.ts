...
export interface HonestGameSolverInterface extends utils.Interface {
  functions: {
...
export interface HonestGameSolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HonestGameSolverInterface;
