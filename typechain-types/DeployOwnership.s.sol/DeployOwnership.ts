...
export interface DeployOwnershipInterface extends utils.Interface {
  functions: {
...
export interface DeployOwnership extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployOwnershipInterface;
