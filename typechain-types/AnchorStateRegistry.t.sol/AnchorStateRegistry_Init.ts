...
export interface AnchorStateRegistry_InitInterface extends utils.Interface {
  functions: {
...
export interface AnchorStateRegistry_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AnchorStateRegistry_InitInterface;
