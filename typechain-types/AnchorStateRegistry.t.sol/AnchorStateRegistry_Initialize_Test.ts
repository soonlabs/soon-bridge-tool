...
export interface AnchorStateRegistry_Initialize_TestInterface
...
export interface AnchorStateRegistry_Initialize_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AnchorStateRegistry_Initialize_TestInterface;
