...
export interface FPACOPS2Interface extends utils.Interface {
  functions: {
    ...
    "deployFPAC2(address,address,address,address,address)": FunctionFragment;
...
export interface FPACOPS2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FPACOPS2Interface;
  ...
  functions: {
    ...
    /**
     * Deploys an updated FP system with new FaultDisputeGame contracts and new         DelayedWETH contracts. Deploys a new implementation of the         AnchorStateRegistry. Does not deploy a new DisputeGameFactory. System         Owner is responsible for updating implementations later.
    ...
    deployFPAC2(
      _proxyAdmin: string,
      _systemOwnerSafe: string,
      _superchainConfigProxy: string,
      _disputeGameFactoryProxy: string,
      _anchorStateRegistryProxy: string,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
