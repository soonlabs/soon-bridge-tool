...
export interface ResolvedDelegateProxy_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_fallback_delegateCallFoo_succeeds(uint256)": FunctionFragment;
    "test_fallback_addressManagerNotSet_reverts()": FunctionFragment;
    "test_fallback_delegateCallBar_reverts()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_fallback_delegateCallFoo_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_fallback_addressManagerNotSet_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_fallback_delegateCallBar_reverts",
    values?: undefined
  ): string;
...
export interface ResolvedDelegateProxy_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResolvedDelegateProxy_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the proxy fallback reverts as expected if the implementation within the      address manager is not set.
     */
    test_fallback_addressManagerNotSet_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
