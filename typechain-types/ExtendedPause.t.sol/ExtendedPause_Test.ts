...
export interface ExtendedPause_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_pause_fullSystem_succeeds()": FunctionFragment;
    "test_unpause_fullSystem_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_unpause_fullSystem_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_pause_fullSystem_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_unpause_fullSystem_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ExtendedPause_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExtendedPause_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that other contracts are paused when the superchain config is paused
     */
    test_pause_fullSystem_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests that other contracts are unpaused when the superchain config is paused and then unpaused.
     */
    test_unpause_fullSystem_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that other contracts are paused when the superchain config is paused
     */
    test_pause_fullSystem_succeeds(overrides?: CallOverrides): Promise<void>;

    /**
     * Tests that other contracts are unpaused when the superchain config is paused and then unpaused.
     */
    test_unpause_fullSystem_succeeds(overrides?: CallOverrides): Promise<void>;
