...
export interface FaultDisputeGame_InitInterface extends utils.Interface {
  functions: {
...
export interface FaultDisputeGame_Init extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FaultDisputeGame_InitInterface;
