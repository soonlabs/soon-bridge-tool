...
export interface FaultDisputeGame_Solvency_InvariantInterface
  ...
  functions: {
    ...
    "invariant_faultDisputeGame_solvency()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "failed"
      | "init"
      | "invariant_faultDisputeGame_solvency"
  ...
  encodeFunctionData(
    functionFragment: "invariant_faultDisputeGame_solvency",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface FaultDisputeGame_Solvency_Invariant extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FaultDisputeGame_Solvency_InvariantInterface;
