...
export interface Initializer_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_cannotReinitialize_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_cannotReinitialize_succeeds"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_cannotReinitialize_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Initializer_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Initializer_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that:         1. All `Initializable` contracts in `src/L1` and `src/L2` are accounted for in the `contracts` array.         2. The `_initialized` flag of each contract is properly set to `1`, signifying that the            contracts are initialized.         3. The `initialize()` function of each contract cannot be called more than once.
     */
    test_cannotReinitialize_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
     ...
     * Tests that:         1. All `Initializable` contracts in `src/L1` and `src/L2` are accounted for in the `contracts` array.         2. The `_initialized` flag of each contract is properly set to `1`, signifying that the            contracts are initialized.         3. The `initialize()` function of each contract cannot be called more than once.
     */
    test_cannotReinitialize_succeeds(overrides?: CallOverrides): Promise<void>;
