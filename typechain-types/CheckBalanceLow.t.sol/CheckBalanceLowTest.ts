...
export interface CheckBalanceLowTestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_check_highBalance_fails(address,uint256)": FunctionFragment;
    "testFuzz_check_succeeds(address,uint256)": FunctionFragment;
...
export interface CheckBalanceLowTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CheckBalanceLowTestInterface;
  ...
  functions: {
    ...
    /**
     * Deploy the `CheckBalanceLow` contract.
     */
    setUp(
    ...
    /**
     * Fuzz the `check` function and assert that it always returns false         when the target's balance is larger than the threshold.
     */
    testFuzz_check_highBalance_fails(
      _target: string,
    ...
    /**
     * Fuzz the `check` function and assert that it always returns true         when the target's balance is smaller than the threshold.
     */
    testFuzz_check_succeeds(
      _target: string,
      _threshold: BigNumberish,
