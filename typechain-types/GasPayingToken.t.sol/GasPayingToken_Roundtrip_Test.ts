...
export interface GasPayingToken_Roundtrip_TestInterface
  ...
  functions: {
    ...
    "testDiff_sanitize_succeeds(string)": FunctionFragment;
    "test_get_empty_succeeds()": FunctionFragment;
    "test_sanitize_empty_succeeds()": FunctionFragment;
    "test_sanitize_stringTooLong_fails(string)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testDiff_sanitize_succeeds"
      | "test_get_empty_succeeds"
      | "test_sanitize_empty_succeeds"
      | "test_sanitize_stringTooLong_fails"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDiff_sanitize_succeeds",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "test_get_empty_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_sanitize_empty_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_sanitize_stringTooLong_fails",
    values: [string]
  ): string;
...
export interface GasPayingToken_Roundtrip_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasPayingToken_Roundtrip_TestInterface;
  ...
  functions: {
    ...
    /**
     * Test that the gas paying token returns values associated with Ether when unset.
     */
    test_get_empty_succeeds(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Test that `sanitize` works as expected when the input string is empty.
     */
    test_sanitize_empty_succeeds(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Test that `sanitize` fails when the input string is too long.
     */
    test_sanitize_stringTooLong_fails(
      _str: string,
  ...
  estimateGas: {
     ...
     * Test that the gas paying token returns values associated with Ether when unset.
     */
    test_get_empty_succeeds(overrides?: CallOverrides): Promise<BigNumber>;

    /**
     * Test that `sanitize` works as expected when the input string is empty.
     */
    test_sanitize_empty_succeeds(overrides?: CallOverrides): Promise<BigNumber>;
