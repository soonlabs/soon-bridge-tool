...
export interface Bytes_slice_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_slice_memorySafety_succeeds(bytes,uint256,uint256)": FunctionFragment;
    "test_slice_acrossMultipleWords_works()": FunctionFragment;
    "test_slice_acrossWords_works()": FunctionFragment;
    "test_slice_fromNonZeroIdx_works()": FunctionFragment;
    "test_slice_fromZeroIdx_works()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_slice_memorySafety_succeeds",
    values: [BytesLike, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_slice_acrossMultipleWords_works",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_slice_acrossWords_works",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_slice_fromNonZeroIdx_works",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_slice_fromZeroIdx_works",
    values?: undefined
  ): string;
...
export interface Bytes_slice_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Bytes_slice_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the `slice` function correctly updates the free memory pointer depending         on the length of the slice.         The calls to `bound` are to reduce the number of times that `assume` is triggered.
     */
    testFuzz_slice_memorySafety_succeeds(
      _input: BytesLike,
      _start: BigNumberish,
    ...
    /**
     * Tests that the `slice` function works as expected when slicing between multiple         words in memory. In this case, we test that a 34 byte slice between 3 separate words        returns the correct result.
     */
    test_slice_acrossMultipleWords_works(
      overrides?: CallOverrides
    ): Promise<[void]>;
    ...
    /**
     * Tests that the `slice` function works as expected when slicing between multiple words         in memory. In this case, we test that a 2 byte slice between the 32nd byte of the         first word and the 1st byte of the second word is correct.
     */
    test_slice_acrossWords_works(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Tests that the `slice` function works as expected when starting from indices [1, 9]         with lengths [1, 9], in reverse order.
     */
    test_slice_fromNonZeroIdx_works(overrides?: CallOverrides): Promise<[void]>;

    /**
     * Tests that the `slice` function works as expected when starting from index 0.
     */
    test_slice_fromZeroIdx_works(overrides?: CallOverrides): Promise<[void]>;
  };
  ...
  estimateGas: {
     ...
     * Tests that the `slice` function works as expected when slicing between multiple words         in memory. In this case, we test that a 2 byte slice between the 32nd byte of the         first word and the 1st byte of the second word is correct.
     */
    test_slice_acrossWords_works(overrides?: CallOverrides): Promise<BigNumber>;
     ...
     * Tests that the `slice` function works as expected when starting from index 0.
     */
    test_slice_fromZeroIdx_works(overrides?: CallOverrides): Promise<BigNumber>;
  };
