...
export interface Bytes_toNibbles_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_toNibbles_memorySafety_succeeds(bytes)": FunctionFragment;
    "test_toNibbles_expectedResult128Bytes_works()": FunctionFragment;
    "test_toNibbles_expectedResult5Bytes_works()": FunctionFragment;
    "test_toNibbles_zeroLengthInput_works()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_toNibbles_memorySafety_succeeds"
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_toNibbles_memorySafety_succeeds",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "test_toNibbles_expectedResult128Bytes_works",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_toNibbles_expectedResult5Bytes_works",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_toNibbles_zeroLengthInput_works",
    values?: undefined
  ): string;
...
export interface Bytes_toNibbles_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Bytes_toNibbles_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the `toNibbles` function correctly updates the free memory pointer depending         on the length of the resulting array.
     */
    testFuzz_toNibbles_memorySafety_succeeds(
      _input: BytesLike,
    ...
    /**
     * Tests that, given an input of 128 bytes, the `toNibbles` function returns an array         of 256 nibbles corresponding to the input data. This test exists to ensure that,         given a large input, the `toNibbles` function works as expected.
     */
    test_toNibbles_expectedResult128Bytes_works(
      overrides?: CallOverrides
    ): Promise<[void]>;
    ...
    /**
     * Tests that, given an input of 5 bytes, the `toNibbles` function returns an array of         10 nibbles corresponding to the input data.
     */
    test_toNibbles_expectedResult5Bytes_works(
      overrides?: CallOverrides
    ): Promise<[void]>;
    ...
    /**
     * Tests that, given an input of 0 bytes, the `toNibbles` function returns a zero         length array.
     */
    test_toNibbles_zeroLengthInput_works(
      overrides?: CallOverrides
    ): Promise<[void]>;
