...
export interface Bytes_equal_TestInterface extends utils.Interface {
  functions: {
    ...
    "testDiff_equal_works(bytes,bytes)": FunctionFragment;
    "testFuzz_equal_notEqual_works(bytes,bytes)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testDiff_equal_works",
    values: [BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_equal_notEqual_works",
    values: [BytesLike, BytesLike]
  ): string;
...
export interface Bytes_equal_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Bytes_equal_TestInterface;
  ...
  functions: {
    ...
    /**
     * Test whether or not the `equal` function in the `Bytes` library is equivalent to         manually checking equality of the two dynamic `bytes` arrays in memory.
     */
    testDiff_equal_works(
      _a: BytesLike,
      _b: BytesLike,
    ...
    /**
     * Tests that the `equal` function in the `Bytes` library returns `false` if given two         non-equal byte arrays.
     */
    testFuzz_equal_notEqual_works(
      _a: BytesLike,
      _b: BytesLike,
