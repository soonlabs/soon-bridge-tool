...
export interface Bytes_slice_TestFailInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_slice_lengthOverflows_reverts(bytes,uint256,uint256)": FunctionFragment;
    "testFuzz_slice_outOfBounds_reverts(bytes,uint256,uint256)": FunctionFragment;
    "testFuzz_slice_rangeOverflows_reverts(bytes,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_slice_lengthOverflows_reverts",
    values: [BytesLike, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_slice_outOfBounds_reverts",
    values: [BytesLike, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_slice_rangeOverflows_reverts",
    values: [BytesLike, BigNumberish, BigNumberish]
  ): string;
...
export interface Bytes_slice_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Bytes_slice_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that, when given a length `n` that is greater than `type(uint256).max - 31`,         the `slice` function reverts.
     */
    testFuzz_slice_lengthOverflows_reverts(
      _input: BytesLike,
      _start: BigNumberish,
    ...
    /**
     * Tests that, when given an input bytes array of length `n`, the `slice` function will         always revert if `_start + _length > n`.
     */
    testFuzz_slice_outOfBounds_reverts(
      _input: BytesLike,
      _start: BigNumberish,
    ...
    /**
     * Tests that, when given a start index `n` that is greater than         `type(uint256).max - n`, the `slice` function reverts.         The calls to `bound` are to reduce the number of times that `assume` is triggered.
     */
    testFuzz_slice_rangeOverflows_reverts(
      _input: BytesLike,
      _start: BigNumberish,
