...
export interface PeripheryDeployConfig0815Interface extends utils.Interface {
  functions: {
...
export interface PeripheryDeployConfig0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PeripheryDeployConfig0815Interface;
