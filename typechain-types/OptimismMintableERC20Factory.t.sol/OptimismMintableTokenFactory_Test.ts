...
export interface OptimismMintableTokenFactory_TestInterface
  ...
  functions: {
    ...
    "test_createStandardL1TokenWithDecimals_remoteIsZero_reverts(address,string,string,uint8)": FunctionFragment;
    "test_createStandardL1TokenWithDecimals_sameTwice_reverts(address,bytes32,string,string,uint8)": FunctionFragment;
    "test_createStandardL1TokenWithDecimals_succeeds(address,bytes32,string,string,uint8)": FunctionFragment;
    "test_createStandardL1Token_remoteIsZero_reverts(address,string,string)": FunctionFragment;
    "test_createStandardL1Token_sameTwice_reverts(address,bytes32,string,string)": FunctionFragment;
    "test_createStandardL1Token_succeeds(address,bytes32,string,string)": FunctionFragment;
    "test_initialize_succeeds()": FunctionFragment;
    "test_upgrading_succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_createStandardL1TokenWithDecimals_remoteIsZero_reverts"
      | "test_createStandardL1TokenWithDecimals_sameTwice_reverts"
      | "test_createStandardL1TokenWithDecimals_succeeds"
      | "test_createStandardL1Token_remoteIsZero_reverts"
      | "test_createStandardL1Token_sameTwice_reverts"
      | "test_createStandardL1Token_succeeds"
  ...
  encodeFunctionData(
    functionFragment: "test_createStandardL1TokenWithDecimals_remoteIsZero_reverts",
    values: [string, string, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL1TokenWithDecimals_sameTwice_reverts",
    values: [string, BytesLike, string, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL1TokenWithDecimals_succeeds",
    values: [string, BytesLike, string, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL1Token_remoteIsZero_reverts",
    values: [string, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL1Token_sameTwice_reverts",
    values: [string, BytesLike, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL1Token_succeeds",
    values: [string, BytesLike, string, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_upgrading_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismMintableTokenFactory_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismMintableTokenFactory_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the constructor is initialized correctly.
     */
    test_constructor_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Test that calling `createStandardL2TokenWithDecimals` with a zero remote token address reverts.
     */
    test_createStandardL1TokenWithDecimals_remoteIsZero_reverts(
      _caller: string,
      _name: string,
    ...
    /**
     * Test that calling `createStandardL2TokenWithDecimals` with the same parameters twice reverts.
     */
    test_createStandardL1TokenWithDecimals_sameTwice_reverts(
      _caller: string,
    ...
    /**
     * Test that calling `createOptimismMintableERC20WithDecimals` with valid parameters succeeds.
     */
    test_createStandardL1TokenWithDecimals_succeeds(
      _caller: string,
      _remoteToken: BytesLike,
    ...
    /**
     * Test that calling `createStandardL2Token` with a zero remote token address reverts.
     */
    test_createStandardL1Token_remoteIsZero_reverts(
      _caller: string,
      _name: string,
    ...
    /**
     * Test that calling `createStandardL2Token` with the same parameters twice reverts.
     */
    test_createStandardL1Token_sameTwice_reverts(
      _caller: string,
      _remoteToken: BytesLike,
    ...
    /**
     * Test that calling `createStandardL2Token` with valid parameters succeeds.
     */
    test_createStandardL1Token_succeeds(
      _caller: string,
      _remoteToken: BytesLike,
  ...
  callStatic: {
     ...
     * Tests that the upgrade is successful.
     */
    test_upgrading_succeeds(overrides?: CallOverrides): Promise<void>;
