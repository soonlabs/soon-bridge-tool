...
export interface Encoding_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_nonceVersioning_succeeds(uint240,uint16)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_nonceVersioning_succeeds",
...
export interface Encoding_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Encoding_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests encoding and decoding a nonce and version.
     */
    testFuzz_nonceVersioning_succeeds(
      _nonce: BigNumberish,
