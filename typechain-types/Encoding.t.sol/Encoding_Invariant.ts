...
export interface Encoding_InvariantInterface extends utils.Interface {
  functions: {
    ...
    "invariant_round_trip_encoding_AToB()": FunctionFragment;
    "invariant_round_trip_encoding_BToA()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_round_trip_encoding_AToB",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "invariant_round_trip_encoding_BToA",
    values?: undefined
  ): string;
...
export interface Encoding_Invariant extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Encoding_InvariantInterface;
  ...
  /**
   */
  invariant_round_trip_encoding_AToB(overrides?: CallOverrides): Promise<void>;

  /**
   */
  invariant_round_trip_encoding_BToA(overrides?: CallOverrides): Promise<void>;
