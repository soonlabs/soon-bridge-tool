...
export interface DeploySuperchain_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_run_ZeroAddressRoleInput_reverts()": FunctionFragment;
    "test_run_succeeds(((address,address,address),bool,uint256,uint256))": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_run_ZeroAddressRoleInput_reverts"
      | "test_run_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_run_ZeroAddressRoleInput_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DeploySuperchain_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeploySuperchain_TestInterface;
