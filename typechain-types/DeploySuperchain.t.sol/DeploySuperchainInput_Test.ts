...
export interface DeploySuperchainInput_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_loadInput_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_loadInput_succeeds",
    values?: undefined
  ): string;
...
export interface DeploySuperchainInput_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeploySuperchainInput_TestInterface;
  ...
  callStatic: {
    ...
    test_loadInput_succeeds(overrides?: CallOverrides): Promise<void>;
  };
