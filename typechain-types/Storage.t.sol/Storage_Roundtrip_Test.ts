...
export interface Storage_Roundtrip_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_setGetBytes32Multi_succeeds((bytes32,bytes32)[])": FunctionFragment;
    "test_setGetAddress_succeeds(bytes32,address)": FunctionFragment;
    "test_setGetBool_succeeds(bytes32,bool)": FunctionFragment;
    "test_setGetBytes32_succeeds(bytes32,bytes32)": FunctionFragment;
    "test_setGetUint_succeeds(bytes32,uint256)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_setGetBytes32Multi_succeeds"
      | "test_setGetAddress_succeeds"
      | "test_setGetBool_succeeds"
      | "test_setGetBytes32_succeeds"
      | "test_setGetUint_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_setGetBytes32Multi_succeeds",
    values: [StorageSetter.SlotStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "test_setGetAddress_succeeds",
    values: [BytesLike, string]
  ): string;
  encodeFunctionData(
    functionFragment: "test_setGetBool_succeeds",
    values: [BytesLike, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "test_setGetBytes32_succeeds",
    values: [BytesLike, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "test_setGetUint_succeeds",
...
export interface Storage_Roundtrip_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Storage_Roundtrip_TestInterface;
  ...
  functions: {
    ...
    testFuzz_setGetBytes32Multi_succeeds(
      _slots: StorageSetter.SlotStruct[],
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
