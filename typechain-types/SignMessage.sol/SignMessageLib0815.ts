...
export interface SignMessageLib0815Interface extends utils.Interface {
  functions: {
...
export interface SignMessageLib0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SignMessageLib0815Interface;
