...
export interface Burn_BurnEth_InvariantInterface extends utils.Interface {
  functions: {
    ...
    "invariant_burn_eth()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_burn_eth",
    values?: undefined
  ): string;
...
export interface Burn_BurnEth_Invariant extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Burn_BurnEth_InvariantInterface;
  ...
  functions: {
    ...
    /**
     */
    invariant_burn_eth(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    /**
     */
    invariant_burn_eth(overrides?: CallOverrides): Promise<BigNumber>;
