...
export interface LivenessModule_RemoveOwners_TestInterface
  ...
  functions: {
    ...
    "test_removeOwners_allOwners_succeeds()": FunctionFragment;
    "test_removeOwners_oneOwner_succeeds()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_removeOwners_allOwners_succeeds"
      | "test_removeOwners_oneOwner_succeeds"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_removeOwners_allOwners_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_removeOwners_oneOwner_succeeds",
    values?: undefined
  ): string;
...
export interface LivenessModule_RemoveOwners_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_RemoveOwners_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests if removing one owner works correctly
     */
    test_removeOwners_oneOwner_succeeds(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
