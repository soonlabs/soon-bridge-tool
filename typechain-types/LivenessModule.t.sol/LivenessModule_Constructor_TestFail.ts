...
export interface LivenessModule_Constructor_TestFailInterface
  ...
  functions: {
    ...
    "test_constructor_minOwnersGreaterThanOwners_reverts()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_constructor_minOwnersGreaterThanOwners_reverts"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_constructor_minOwnersGreaterThanOwners_reverts",
    values?: undefined
  ): string;
...
export interface LivenessModule_Constructor_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_Constructor_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests that the constructor fails if the minOwners is greater than the number of owners
     */
    test_constructor_minOwnersGreaterThanOwners_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
