...
export interface LivenessModule_TestInitInterface extends utils.Interface {
  functions: {
...
export interface LivenessModule_TestInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_TestInitInterface;
