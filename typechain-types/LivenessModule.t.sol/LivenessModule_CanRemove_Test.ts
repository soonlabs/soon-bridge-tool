...
export interface LivenessModule_CanRemove_TestInterface
  ...
  functions: {
    ...
    "test_canRemove_works()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_canRemove_works",
    values?: undefined
  ): string;
...
export interface LivenessModule_CanRemove_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_CanRemove_TestInterface;
  ...
  callStatic: {
     ...
     * Tests if canRemove work correctly
     */
    test_canRemove_works(overrides?: CallOverrides): Promise<void>;
  };
