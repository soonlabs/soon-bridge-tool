...
export interface LivenessModule_Getters_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_getters_works()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_getters_works",
    values?: undefined
  ): string;
...
export interface LivenessModule_Getters_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_Getters_TestInterface;
  ...
  functions: {
    ...
    /**
     * Tests if the getters work correctly
     */
    test_getters_works(overrides?: CallOverrides): Promise<[void]>;
  };
  ...
  estimateGas: {
     ...
     * Tests if the getters work correctly
     */
    test_getters_works(overrides?: CallOverrides): Promise<BigNumber>;
  };
