...
export interface LivenessModule_GetRequiredThreshold_TestInterface
  ...
  functions: {
    ...
    "testFuzz_getRequiredThreshold_atBoundaries_works(uint256)": FunctionFragment;
    "testFuzz_getRequiredThreshold_works(uint256,uint256)": FunctionFragment;
    "test_getRequiredThreshold_hardcoded_works()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_getRequiredThreshold_atBoundaries_works"
      | "testFuzz_getRequiredThreshold_works"
      | "test_getRequiredThreshold_hardcoded_works"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_getRequiredThreshold_atBoundaries_works",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_getRequiredThreshold_works",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_getRequiredThreshold_hardcoded_works",
    values?: undefined
  ): string;
...
export interface LivenessModule_GetRequiredThreshold_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_GetRequiredThreshold_TestInterface;
  ...
  functions: {
    ...
    /**
     * check the return values of the getRequiredThreshold function against the boundary conditions of 1 and 100      percent.
     */
    testFuzz_getRequiredThreshold_atBoundaries_works(
    ...
    /**
     * Differentially tests the getRequiredThreshold function against _getLeastIntegerValueAbovePercentage
     */
    testFuzz_getRequiredThreshold_works(
      _numOwners: BigNumberish,
    ...
    /**
     * check the return values of the getRequiredThreshold function against manually      calculated values.
     */
    test_getRequiredThreshold_hardcoded_works(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
