...
export interface LivenessModule_RemoveOwnersFuzz_TestInterface
  ...
  functions: {
    ...
    "testFuzz_removeOwners(uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_removeOwners",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export interface LivenessModule_RemoveOwnersFuzz_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_RemoveOwnersFuzz_TestInterface;
  ...
  functions: {
    ...
    /**
     * This contract inherits the storage layout from the LivenessModule_TestInit contract, but we      override the base setUp function, to avoid instantiating an unnecessary Safe and liveness checking system.
     */
    setUp(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    /**
     * Tests if removing owners works correctly for various safe configurations and numbeers of live owners
     */
    testFuzz_removeOwners(
      _numOwners: BigNumberish,
      _minOwners: BigNumberish,
      _numLiveOwners: BigNumberish,
      _thresholdPercentage: BigNumberish,
      _shutDownBehavior: BigNumberish,
      _numOwnersToRemoveinShutDown: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  };
