...
export interface LivenessModule_CanRemove_TestFailInterface
  ...
  functions: {
    ...
    "test_canRemove_notSafeOwner_reverts()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_canRemove_notSafeOwner_reverts"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_canRemove_notSafeOwner_reverts",
    values?: undefined
  ): string;
...
export interface LivenessModule_CanRemove_TestFail extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LivenessModule_CanRemove_TestFailInterface;
  ...
  functions: {
    ...
    /**
     * Tests if canRemove work correctly
     */
    test_canRemove_notSafeOwner_reverts(
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
