...
export interface AssetReceiver0815Interface extends utils.Interface {
  functions: {
...
export interface AssetReceiver0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetReceiver0815Interface;
