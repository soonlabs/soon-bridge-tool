...
export interface Bridge_InitializerInterface extends utils.Interface {
  functions: {
...
export interface Bridge_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Bridge_InitializerInterface;
