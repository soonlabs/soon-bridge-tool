...
export interface SubmitLPPInterface extends utils.Interface {
  functions: {
    "IS_SCRIPT()": FunctionFragment;
    "failed()": FunctionFragment;
    "post(address)": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "IS_SCRIPT" | "failed" | "post"
  ): FunctionFragment;
...
export interface SubmitLPP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SubmitLPPInterface;
  ...
  callStatic: {
    ...
    post(_po: string, overrides?: CallOverrides): Promise<void>;
  };
