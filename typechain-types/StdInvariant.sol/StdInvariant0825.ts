...
export interface StdInvariant0825Interface extends utils.Interface {
  functions: {
...
export interface StdInvariant0825 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdInvariant0825Interface;
