...
export interface StdInvariant0815Interface extends utils.Interface {
  functions: {
...
export interface StdInvariant0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StdInvariant0815Interface;
