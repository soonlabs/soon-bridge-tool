...
export interface IFaultDisputeGame0815Interface extends utils.Interface {
  functions: {
...
export interface IFaultDisputeGame0815 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFaultDisputeGame0815Interface;
