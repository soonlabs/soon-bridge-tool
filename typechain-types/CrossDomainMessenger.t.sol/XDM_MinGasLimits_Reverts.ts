...
export interface XDM_MinGasLimits_RevertsInterface extends utils.Interface {
  functions: {
...
export interface XDM_MinGasLimits_Reverts extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XDM_MinGasLimits_RevertsInterface;
