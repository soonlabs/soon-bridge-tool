...
export interface ExternalRelayInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "excludeArtifacts()": FunctionFragment;
    "excludeContracts()": FunctionFragment;
    "excludeSenders()": FunctionFragment;
    "externalCallWithMinGas()": FunctionFragment;
    "failed()": FunctionFragment;
    "getCallData()": FunctionFragment;
    "setFuzzedSender(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "externalCallWithMinGas",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setFuzzedSender",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface ExternalRelay extends BaseContract {
  ...
  functions: {
     ...
     */
    getCallData(overrides?: CallOverrides): Promise<[string]>;

    /**
     * Helper function to set the fuzzed sender
     */
    setFuzzedSender(
      _fuzzedSender: BytesLike,
  ...
  callStatic: {
     ...
     * externalCallWithMinGas is called by the CrossDomainMessenger.
     */
    externalCallWithMinGas(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
     ...
     * Helper function to get the callData for an `externalCallWithMinGas
     */
    getCallData(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
     ...
     * Helper function to get the callData for an `externalCallWithMinGas
     */
    getCallData(overrides?: CallOverrides): Promise<PopulatedTransaction>;
