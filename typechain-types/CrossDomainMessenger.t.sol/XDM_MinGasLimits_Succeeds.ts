...
export interface XDM_MinGasLimits_SucceedsInterface extends utils.Interface {
  functions: {
    ...
    "invariant_minGasLimits()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_minGasLimits",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface XDM_MinGasLimits_Succeeds extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XDM_MinGasLimits_SucceedsInterface;
  ...
  functions: {
    ...
    /**
     */
    invariant_minGasLimits(overrides?: CallOverrides): Promise<[void]>;
  ...
  callStatic: {
    ...
    init(doFail: boolean, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    /**
     */
    invariant_minGasLimits(overrides?: CallOverrides): Promise<BigNumber>;
