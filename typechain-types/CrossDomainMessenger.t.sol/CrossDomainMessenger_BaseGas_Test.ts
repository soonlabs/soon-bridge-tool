...
export interface CrossDomainMessenger_BaseGas_TestInterface
  ...
  functions: {
    ...
    "testFuzz_baseGas_portalMinGasLimit_succeeds(bytes,uint32)": FunctionFragment;
    "testFuzz_baseGas_succeeds(uint32)": FunctionFragment;
    "test_baseGas_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_baseGas_portalMinGasLimit_succeeds",
    values: [BytesLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_baseGas_succeeds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_baseGas_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CrossDomainMessenger_BaseGas_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossDomainMessenger_BaseGas_TestInterface;
  ...
  functions: {
    ...
    /**
     * The baseGas function should always return a value greater than         or equal to the minimum gas limit value on the OptimismPortal.         This guarantees that the messengers will always pass sufficient         gas to the OptimismPortal.
     */
    testFuzz_baseGas_portalMinGasLimit_succeeds(
      _data: BytesLike,
    ...
    /**
     * Ensure that baseGas passes for the max value of _minGasLimit,      this is about 4 Billion.
     */
    test_baseGas_succeeds(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
     ...
     * Ensure that baseGas passes for the max value of _minGasLimit,      this is about 4 Billion.
     */
    test_baseGas_succeeds(overrides?: CallOverrides): Promise<BigNumber>;
