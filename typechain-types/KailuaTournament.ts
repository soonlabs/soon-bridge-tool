...
export interface KailuaTournamentInterface extends utils.Interface {
  functions: {
...
export interface KailuaTournament extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KailuaTournamentInterface;
