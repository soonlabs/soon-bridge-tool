...
import {base58PublicKeyToHex, isValidEthereumAddress, isValidSolanaPublicKey} from './helper/tool';
...
async function main() {
    ...
    const ERC20 = new ethers.Contract(args.l1Token, iface, EVMContext.EVM_PROVIDER);
